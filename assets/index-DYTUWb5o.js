(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const c of n)if(c.type==="childList")for(const a of c.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function r(n){const c={};return n.integrity&&(c.integrity=n.integrity),n.referrerPolicy&&(c.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?c.credentials="include":n.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function o(n){if(n.ep)return;n.ep=!0;const c=r(n);fetch(n.href,c)}})();const y=".",B=Symbol("target"),Z=Symbol("unsubscribe");function D(e){return e instanceof Date||e instanceof Set||e instanceof Map||e instanceof WeakSet||e instanceof WeakMap||ArrayBuffer.isView(e)}function ae(e){return(typeof e=="object"?e===null:typeof e!="function")||e instanceof RegExp}const u=Array.isArray;function x(e){return typeof e=="symbol"}const R={after(e,t){return u(e)?e.slice(t.length):t===""?e:e.slice(t.length+1)},concat(e,t){return u(e)?(e=[...e],t&&e.push(t),e):t&&t.toString!==void 0?(e!==""&&(e+=y),x(t)?e+t.toString():e+t):e},initial(e){if(u(e))return e.slice(0,-1);if(e==="")return e;const t=e.lastIndexOf(y);return t===-1?"":e.slice(0,t)},last(e){if(u(e))return e.at(-1)??"";if(e==="")return e;const t=e.lastIndexOf(y);return t===-1?e:e.slice(t+1)},walk(e,t){if(u(e))for(const r of e)t(r);else if(e!==""){let r=0,o=e.indexOf(y);if(o===-1)t(e);else for(;r<e.length;)o===-1&&(o=e.length),t(e.slice(r,o)),r=o+1,o=e.indexOf(y,r)}},get(e,t){return this.walk(t,r=>{e&&(e=e[r])}),e},isSubPath(e,t){if(u(e)){if(e.length<t.length)return!1;for(let r=0;r<t.length;r++)if(e[r]!==t[r])return!1;return!0}return e.length<t.length?!1:e===t?!0:e.startsWith(t)?e[t.length]===y:!1},isRootPath(e){return u(e)?e.length===0:e===""}};function ie(e){return typeof e=="object"&&typeof e.next=="function"}function de(e,t,r,o,n){const c=e.next;if(t.name==="entries")e.next=function(){const a=c.call(this);return a.done===!1&&(a.value[0]=n(a.value[0],t,a.value[0],o),a.value[1]=n(a.value[1],t,a.value[0],o)),a};else if(t.name==="values"){const a=r[B].keys();e.next=function(){const h=c.call(this);return h.done===!1&&(h.value=n(h.value,t,a.next().value,o)),h}}else e.next=function(){const a=c.call(this);return a.done===!1&&(a.value=n(a.value,t,a.value,o)),a};return e}function z(e,t,r){return e.isUnsubscribed||t.ignoreSymbols&&x(r)||t.ignoreUnderscores&&r.charAt(0)==="_"||"ignoreKeys"in t&&t.ignoreKeys.includes(r)}class le{constructor(t){this._equals=t,this._proxyCache=new WeakMap,this._pathCache=new WeakMap,this.isUnsubscribed=!1}_getDescriptorCache(){return this._descriptorCache===void 0&&(this._descriptorCache=new WeakMap),this._descriptorCache}_getProperties(t){const r=this._getDescriptorCache();let o=r.get(t);return o===void 0&&(o={},r.set(t,o)),o}_getOwnPropertyDescriptor(t,r){if(this.isUnsubscribed)return Reflect.getOwnPropertyDescriptor(t,r);const o=this._getProperties(t);let n=o[r];return n===void 0&&(n=Reflect.getOwnPropertyDescriptor(t,r),o[r]=n),n}getProxy(t,r,o,n){if(this.isUnsubscribed)return t;const c=t[n],a=c??t;this._pathCache.set(a,r);let h=this._proxyCache.get(a);return h===void 0&&(h=c===void 0?new Proxy(t,o):t,this._proxyCache.set(a,h)),h}getPath(t){return this.isUnsubscribed?void 0:this._pathCache.get(t)}isDetached(t,r){return!Object.is(t,R.get(r,this.getPath(t)))}defineProperty(t,r,o){return Reflect.defineProperty(t,r,o)?(this.isUnsubscribed||(this._getProperties(t)[r]=o),!0):!1}setProperty(t,r,o,n,c){if(!this._equals(c,o)||!(r in t)){const a=this._getOwnPropertyDescriptor(t,r);return a!==void 0&&"set"in a?Reflect.set(t,r,o,n):Reflect.set(t,r,o)}return!0}deleteProperty(t,r,o){if(Reflect.deleteProperty(t,r)){if(!this.isUnsubscribed){const n=this._getDescriptorCache().get(t);n&&(delete n[r],this._pathCache.delete(o))}return!0}return!1}isSameDescriptor(t,r,o){const n=this._getOwnPropertyDescriptor(r,o);return t!==void 0&&n!==void 0&&Object.is(t.value,n.value)&&(t.writable||!1)===(n.writable||!1)&&(t.enumerable||!1)===(n.enumerable||!1)&&(t.configurable||!1)===(n.configurable||!1)&&t.get===n.get&&t.set===n.set}isGetInvariant(t,r){const o=this._getOwnPropertyDescriptor(t,r);return o!==void 0&&o.configurable!==!0&&o.writable!==!0}unsubscribe(){this._descriptorCache=null,this._pathCache=null,this._proxyCache=null,this.isUnsubscribed=!0}}function Q(e){return toString.call(e)==="[object Object]"}function M(){return!0}function A(e,t){return e.length!==t.length||e.some((r,o)=>t[o]!==r)}const ee=new Set(["hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"]),he=new Set(["concat","includes","indexOf","join","keys","lastIndexOf"]),te={push:M,pop:M,shift:M,unshift:M,copyWithin:A,reverse:A,sort:A,splice:A,flat:A,fill:A},fe=new Set([...ee,...he,...Object.keys(te)]);function L(e,t){if(e.size!==t.size)return!0;for(const r of e)if(!t.has(r))return!0;return!1}const re=["keys","values","entries"],oe=new Set(["has","toString"]),ne={add:L,clear:L,delete:L,forEach:L},me=new Set([...oe,...Object.keys(ne),...re]);function E(e,t){if(e.size!==t.size)return!0;let r;for(const[o,n]of e)if(r=t.get(o),r!==n||r===void 0&&!t.has(o))return!0;return!1}const ue=new Set([...oe,"get"]),se={set:E,clear:E,delete:E,forEach:E},Re=new Set([...ue,...Object.keys(se),...re]);class _{constructor(t,r,o,n){this._path=r,this._isChanged=!1,this._clonedCache=new Set,this._hasOnValidate=n,this._changes=n?[]:null,this.clone=r===void 0?t:this._shallowClone(t)}static isHandledMethod(t){return ee.has(t)}_shallowClone(t){let r=t;if(Q(t))r={...t};else if(u(t)||ArrayBuffer.isView(t))r=[...t];else if(t instanceof Date)r=new Date(t);else if(t instanceof Set)r=new Set([...t].map(o=>this._shallowClone(o)));else if(t instanceof Map){r=new Map;for(const[o,n]of t.entries())r.set(o,this._shallowClone(n))}return this._clonedCache.add(r),r}preferredThisArg(t,r,o,n){return t?(u(n)?this._onIsChanged=te[r]:n instanceof Set?this._onIsChanged=ne[r]:n instanceof Map&&(this._onIsChanged=se[r]),n):o}update(t,r,o){const n=R.after(t,this._path);if(r!=="length"){let c=this.clone;R.walk(n,a=>{c!=null&&c[a]&&(this._clonedCache.has(c[a])||(c[a]=this._shallowClone(c[a])),c=c[a])}),this._hasOnValidate&&this._changes.push({path:n,property:r,previous:o}),c!=null&&c[r]&&(c[r]=o)}this._isChanged=!0}undo(t){let r;for(let o=this._changes.length-1;o!==-1;o--)r=this._changes[o],R.get(t,r.path)[r.property]=r.previous}isChanged(t){return this._onIsChanged===void 0?this._isChanged:this._onIsChanged(this.clone,t)}isPathApplicable(t){return R.isRootPath(this._path)||R.isSubPath(t,this._path)}}class G extends _{static isHandledMethod(t){return fe.has(t)}}class be extends _{undo(t){t.setTime(this.clone.getTime())}isChanged(t,r){return!r(this.clone.valueOf(),t.valueOf())}}class j extends _{static isHandledMethod(t){return me.has(t)}undo(t){for(const r of this.clone)t.add(r);for(const r of t)this.clone.has(r)||t.delete(r)}}class K extends _{static isHandledMethod(t){return Re.has(t)}undo(t){for(const[r,o]of this.clone.entries())t.set(r,o);for(const r of t.keys())this.clone.has(r)||t.delete(r)}}class we extends _{constructor(t,r,o,n){super(void 0,r,o,n),this._argument1=o[0],this._weakValue=t.has(this._argument1)}isChanged(t){return this._weakValue!==t.has(this._argument1)}undo(t){this._weakValue&&!t.has(this._argument1)?t.add(this._argument1):t.delete(this._argument1)}}class Se extends _{constructor(t,r,o,n){super(void 0,r,o,n),this._weakKey=o[0],this._weakHas=t.has(this._weakKey),this._weakValue=t.get(this._weakKey)}isChanged(t){return this._weakValue!==t.get(this._weakKey)}undo(t){const r=t.has(this._weakKey);this._weakHas&&!r?t.set(this._weakKey,this._weakValue):!this._weakHas&&r?t.delete(this._weakKey):this._weakValue!==t.get(this._weakKey)&&t.set(this._weakKey,this._weakValue)}}class k{constructor(t){this._stack=[],this._hasOnValidate=t}static isHandledType(t){return Q(t)||u(t)||D(t)}static isHandledMethod(t,r){return Q(t)?_.isHandledMethod(r):u(t)?G.isHandledMethod(r):t instanceof Set?j.isHandledMethod(r):t instanceof Map?K.isHandledMethod(r):D(t)}get isCloning(){return this._stack.length>0}start(t,r,o){let n=_;u(t)?n=G:t instanceof Date?n=be:t instanceof Set?n=j:t instanceof Map?n=K:t instanceof WeakSet?n=we:t instanceof WeakMap&&(n=Se),this._stack.push(new n(t,r,o,this._hasOnValidate))}update(t,r,o){this._stack.at(-1).update(t,r,o)}preferredThisArg(t,r,o){const{name:n}=t,c=k.isHandledMethod(o,n);return this._stack.at(-1).preferredThisArg(c,n,r,o)}isChanged(t,r,o){return this._stack.at(-1).isChanged(t,r,o)}isPartOfClone(t){return this._stack.at(-1).isPathApplicable(t)}undo(t){this._previousClone!==void 0&&this._previousClone.undo(t)}stop(){return this._previousClone=this._stack.pop(),this._previousClone.clone}}const qe={equals:Object.is,isShallow:!1,pathAsArray:!1,ignoreSymbols:!1,ignoreUnderscores:!1,ignoreDetached:!1,details:!1},V=(e,t,r={})=>{r={...qe,...r};const o=Symbol("ProxyTarget"),{equals:n,isShallow:c,ignoreDetached:a,details:h}=r,i=new le(n),q=typeof r.onValidate=="function",m=new k(q),g=(s,p,d,l,f)=>!q||m.isCloning||r.onValidate(R.concat(i.getPath(s),p),d,l,f)===!0,$=(s,p,d,l)=>{!z(i,r,p)&&!(a&&i.isDetached(s,e))&&v(i.getPath(s),p,d,l)},v=(s,p,d,l,f)=>{m.isCloning&&m.isPartOfClone(s)?m.update(s,p,l):t(R.concat(s,p),d,l,f)},C=s=>s&&(s[o]??s),T=(s,p,d,l)=>{if(ae(s)||d==="constructor"||c&&!k.isHandledMethod(p,d)||z(i,r,d)||i.isGetInvariant(p,d)||a&&i.isDetached(p,e))return s;l===void 0&&(l=i.getPath(p));const f=R.concat(l,d),b=i.getPath(s);return b&&ce(f,b)?i.getProxy(s,b,H,o):i.getProxy(s,f,H,o)},ce=(s,p)=>{if(x(s)||s.length<=p.length||u(p)&&p.length===0)return!1;const d=u(s)?s:s.split(y),l=u(p)?p:p.split(y);return d.length<=l.length?!1:!l.some((f,b)=>f!==d[b])},H={get(s,p,d){if(x(p)){if(p===o||p===B)return s;if(p===Z&&!i.isUnsubscribed&&i.getPath(s).length===0)return i.unsubscribe(),s}const l=D(s)?Reflect.get(s,p):Reflect.get(s,p,d);return T(l,s,p)},set(s,p,d,l){d=C(d);const f=s[o]??s,b=f[p];if(n(b,d)&&p in s)return!0;const w=g(s,p,d,b);return w&&i.setProperty(f,p,d,l,b)?($(s,p,s[p],b),!0):!w},defineProperty(s,p,d){if(!i.isSameDescriptor(d,s,p)){const l=s[p];g(s,p,d.value,l)&&i.defineProperty(s,p,d,l)&&$(s,p,d.value,l)}return!0},deleteProperty(s,p){if(!Reflect.has(s,p))return!0;const d=Reflect.get(s,p),l=g(s,p,void 0,d);return l&&i.deleteProperty(s,p,d)?($(s,p,void 0,d),!0):!l},apply(s,p,d){const l=p[o]??p;if(i.isUnsubscribed)return Reflect.apply(s,l,d);if((h===!1||h!==!0&&!h.includes(s.name))&&k.isHandledType(l)){let f=R.initial(i.getPath(s));const b=k.isHandledMethod(l,s.name);m.start(l,f,d);let w=Reflect.apply(s,m.preferredThisArg(s,p,l),b?d.map(I=>C(I)):d);const pe=m.isChanged(l,n),U=m.stop();if(k.isHandledType(w)&&b&&(p instanceof Map&&s.name==="get"&&(f=R.concat(f,d[0])),w=i.getProxy(w,f,H)),pe){const I={name:s.name,args:d,result:w},F=m.isCloning?R.initial(f):f,W=m.isCloning?R.last(f):"";g(R.get(e,F),W,l,U,I)?v(F,W,l,U,I):m.undo(l)}return(p instanceof Map||p instanceof Set)&&ie(w)?de(w,s,p,f,T):w}return Reflect.apply(s,p,d)}},O=i.getProxy(e,r.pathAsArray?[]:"",H);return t=t.bind(O),q&&(r.onValidate=r.onValidate.bind(O)),O};V.target=e=>(e==null?void 0:e[B])??e;V.unsubscribe=e=>(e==null?void 0:e[Z])??e;const S=e=>e.split(".").slice(0,3).reverse().join("."),ge=e=>Array(4).fill(0).map((r,o)=>256-2**(8-Math.min(8,Math.max(0,e-o*8)))).join("."),ye=e=>{const t=e.split(".").map(Number),r=t[3]+3;return t[3]=r,t.join(".")},P=e=>e.split(".")[3],_e=({devices:e})=>`
<p>Запуск ISP</p>
...
<p><pre><code>${P(e.hqSrv.interfaces.hqRtr.ip)}&#9;IN&#9;PTR&#9;hq-srv.au-team.irpo.</code></pre></p>
<p><pre><code>${P(e.hqRtr.interfaces.hqSrv.ip)}&#9;IN&#9;PTR&#9;hq-rtr.au-team.irpo.</code></pre></p>
<br>
...
<p><pre><code>&#9;IN&#9;A&#9;${e.hqSrv.interfaces.hqRtr.ip}</code></pre></p>
<p><pre><code>${P(e.hqCli.interfaces.hqRtr.ip)}&#9;IN&#9;PTR&#9;hq-cli.au-team.irpo.</code></pre></p>
<p><pre><code>${P(e.hqRtr.interfaces.hqCli.ip)}&#9;IN&#9;PTR&#9;hq-rtr.au-team.irpo.</code></pre></p>
<br>
...
`,ke=(e,{devices:t})=>{const r=document.createElement("table"),o=document.createElement("thead");o.innerHTML=`
  ...
  `,r.appendChild(o);const n=document.createElement("tbody");Object.values(t).forEach(({name:c,interfaces:a})=>{const h=Object.values(a);if(!h.length)return;const i=document.createElement("tr");i.innerHTML=`
      <td rowspan="${h.length}">${c}</td>
      <td>${h[0].destination||"-"}</td>
      <td>${h[0].ip}</td>
      <td>${h[0].mask}</td>
      <td>${h[0].gateway}</td>
    `,n.appendChild(i);for(let q=1;q<h.length;q+=1){const m=h[q],g=document.createElement("tr");g.innerHTML=`
        <td>${m.destination||"-"}</td>
        <td>${m.ip}</td>
        <td>${m.mask}</td>
        <td>${m.gateway}</td>
      `,n.appendChild(g)}}),r.appendChild(n),e.ipTableContainer.innerHTML="",e.ipTableContainer.appendChild(r)},Ae=(e,t)=>{const r=_e(t);e.textContainer.innerHTML=r,document.querySelectorAll("code").forEach(o=>{const n=document.createElement("span");n.className="code-wrapper";const c=document.createElement("div");c.className="code-copy-toast",c.textContent="Скопировано!",o.parentNode.insertBefore(n,o),n.appendChild(o),n.appendChild(c),o.style.cursor="pointer",o.title="Кликни, чтобы скопировать",o.addEventListener("click",()=>{navigator.clipboard.writeText(o.innerText).then(()=>{c.classList.add("show"),setTimeout(()=>c.classList.remove("show"),300)})})})},$e=(e,t)=>(r,o)=>{switch(r){case"devices":ke(e,t),Ae(e,t);break}};function ve(e,t){const r=document.createElement("form");r.id="network-form",r.innerHTML="<h3>Настройки сетей</h3>",e.forEach(n=>{const c=document.createElement("div");c.className="network-input";const a=document.createElement("label");a.textContent=`Сеть ${n}:`;const h=document.createElement("input");h.type="text",h.placeholder="Адрес сети (напр. 192.168.0.0)",h.dataset.network=n;const i=document.createElement("input");i.type="text",i.placeholder="Маска (напр. 24)",i.dataset.network=n,c.append(a,h,i),r.append(c)});const o=document.createElement("button");o.type="button",o.textContent="Обновить",r.append(o),t.innerHTML="",t.append(r)}function Ce(){const e=document.querySelectorAll("#network-form input"),t={};return e.forEach(r=>{const{network:o}=r.dataset;t[o]||(t[o]={}),r.placeholder.includes("Адрес сети")?t[o].address=r.value.trim():t[o].mask=r.value.trim()}),t}function N(e){return e.split(".").reduce((t,r)=>(t<<8)+parseInt(r,10),0)>>>0}function Y(e){return[e>>>24&255,e>>>16&255,e>>>8&255,e&255].join(".")}function X(e,t){const r=t?4294967295<<32-t:0;return e&~r}function Te(e,t){const r=JSON.parse(JSON.stringify(e));return Object.entries(t).forEach(([o,n])=>{if(!n.address||!n.mask)return;const c=N(n.address),a=parseInt(n.mask,10);Object.values(r).forEach(h=>{Object.values(h.interfaces).forEach(i=>{if(i.netAddress===o){const q=N(i.ip),m=parseInt(i.mask,10),g=X(q,m),$=c&4294967295<<32-a|g;if(i.ip=Y($),i.mask=n.mask.toString(),i.netAddress=n.address,i.gateway!=="-"){const v=N(i.gateway),C=X(v,m),T=c&4294967295<<32-a|C;i.gateway=Y(T)}}})})}),r}const J={isp:{name:"ISP",interfaces:{external:{name:"ens18",ip:"<ВНЕШНИЙ>",mask:"24",gateway:"<ВНЕШНИЙ>",destination:"Интернет",netAddress:""},hqRtr:{name:"ens19",ip:"172.16.4.1",mask:"28",gateway:"-",destination:"HQ-RTR",netAddress:"172.16.4.0"},brRtr:{name:"ens20",ip:"172.16.5.1",mask:"28",gateway:"-",destination:"BR-RTR",netAddress:"172.16.5.0"}}},hqRtr:{name:"HQ-RTR",interfaces:{isp:{name:"ens18",ip:"172.16.4.2",mask:"28",gateway:"172.16.4.1",destination:"ISP",netAddress:"172.16.4.0"},brRtr:{name:"gre1",ip:"10.5.5.1",mask:"30",gateway:"-",destination:"BR-RTR",netAddress:"10.5.5.0"},hqSrv:{name:"VLAN100",ip:"192.168.100.1",mask:"26",gateway:"-",destination:"HQ-SRV",netAddress:"192.168.100.0"},hqCli:{name:"VLAN200",ip:"192.168.200.1",mask:"28",gateway:"-",destination:"HQ-CLI",netAddress:"192.168.200.0"},vlan999:{name:"VLAN999",ip:"192.168.99.1",mask:"29",gateway:"-",destination:"VLAN999 (?)",netAddress:"192.168.99.0"}}},hqSrv:{name:"HQ-SRV",interfaces:{hqRtr:{name:"ens18",ip:"192.168.100.2",mask:"26",gateway:"192.168.100.1",destination:"HQ-RTR",netAddress:"192.168.100.0"}}},hqCli:{name:"HQ-CLI",interfaces:{hqRtr:{name:"ens18",ip:"192.168.200.2",mask:"28",gateway:"192.168.200.1",destination:"HQ-RTR",netAddress:"192.168.200.0"}}},brRtr:{name:"BR-RTR",interfaces:{isp:{name:"ens18",ip:"172.16.5.2",mask:"28",gateway:"172.16.5.1",destination:"ISP",netAddress:"172.16.5.0"},brSrv:{name:"ens19",ip:"192.168.0.1",mask:"27",gateway:"-",destination:"BR-SRV",netAddress:"192.168.0.0"},hqRtr:{name:"gre1",ip:"10.5.5.2",mask:"30",gateway:"-",destination:"HQ-RTR",netAddress:"10.5.5.0"}}},brSrv:{name:"BR-SRV",interfaces:{brRtr:{name:"ens18",ip:"192.168.0.2",mask:"27",gateway:"192.168.0.1",destination:"BR-RTR",netAddress:"192.168.0.0"}}}},He=["ISP-HQ","ISP-BR","GRE","CLI-Net (vlan100)","SRV-Net (vlan200)","vlan999","BR-Net"],Ie=()=>{const e={ipTableContainer:document.getElementById("ip-table-container"),textContainer:document.getElementById("text-container"),networkFormContainer:document.getElementById("network-form-container")},t={devices:[]},r=V(t,$e(e,t));r.devices=J;const o=JSON.parse(JSON.stringify(J));ve(He,e.networkFormContainer),document.querySelector("#network-form button").addEventListener("click",()=>{const n=Ce(),c=Te(o,n);console.log(c),r.devices=c})};Ie();
