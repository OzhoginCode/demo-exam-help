(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function r(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(s){if(s.ep)return;s.ep=!0;const a=r(s);fetch(s.href,a)}})();const _=".",F=Symbol("target"),Z=Symbol("unsubscribe");function Q(e){return e instanceof Date||e instanceof Set||e instanceof Map||e instanceof WeakSet||e instanceof WeakMap||ArrayBuffer.isView(e)}function ie(e){return(typeof e=="object"?e===null:typeof e!="function")||e instanceof RegExp}const u=Array.isArray;function M(e){return typeof e=="symbol"}const b={after(e,t){return u(e)?e.slice(t.length):t===""?e:e.slice(t.length+1)},concat(e,t){return u(e)?(e=[...e],t&&e.push(t),e):t&&t.toString!==void 0?(e!==""&&(e+=_),M(t)?e+t.toString():e+t):e},initial(e){if(u(e))return e.slice(0,-1);if(e==="")return e;const t=e.lastIndexOf(_);return t===-1?"":e.slice(0,t)},last(e){if(u(e))return e.at(-1)??"";if(e==="")return e;const t=e.lastIndexOf(_);return t===-1?e:e.slice(t+1)},walk(e,t){if(u(e))for(const r of e)t(r);else if(e!==""){let r=0,n=e.indexOf(_);if(n===-1)t(e);else for(;r<e.length;)n===-1&&(n=e.length),t(e.slice(r,n)),r=n+1,n=e.indexOf(_,r)}},get(e,t){return this.walk(t,r=>{e&&(e=e[r])}),e},isSubPath(e,t){if(u(e)){if(e.length<t.length)return!1;for(let r=0;r<t.length;r++)if(e[r]!==t[r])return!1;return!0}return e.length<t.length?!1:e===t?!0:e.startsWith(t)?e[t.length]===_:!1},isRootPath(e){return u(e)?e.length===0:e===""}};function pe(e){return typeof e=="object"&&typeof e.next=="function"}function de(e,t,r,n,s){const a=e.next;if(t.name==="entries")e.next=function(){const i=a.call(this);return i.done===!1&&(i.value[0]=s(i.value[0],t,i.value[0],n),i.value[1]=s(i.value[1],t,i.value[0],n)),i};else if(t.name==="values"){const i=r[F].keys();e.next=function(){const h=a.call(this);return h.done===!1&&(h.value=s(h.value,t,i.next().value,n)),h}}else e.next=function(){const i=a.call(this);return i.done===!1&&(i.value=s(i.value,t,i.value,n)),i};return e}function z(e,t,r){return e.isUnsubscribed||t.ignoreSymbols&&M(r)||t.ignoreUnderscores&&r.charAt(0)==="_"||"ignoreKeys"in t&&t.ignoreKeys.includes(r)}class le{constructor(t){this._equals=t,this._proxyCache=new WeakMap,this._pathCache=new WeakMap,this.isUnsubscribed=!1}_getDescriptorCache(){return this._descriptorCache===void 0&&(this._descriptorCache=new WeakMap),this._descriptorCache}_getProperties(t){const r=this._getDescriptorCache();let n=r.get(t);return n===void 0&&(n={},r.set(t,n)),n}_getOwnPropertyDescriptor(t,r){if(this.isUnsubscribed)return Reflect.getOwnPropertyDescriptor(t,r);const n=this._getProperties(t);let s=n[r];return s===void 0&&(s=Reflect.getOwnPropertyDescriptor(t,r),n[r]=s),s}getProxy(t,r,n,s){if(this.isUnsubscribed)return t;const a=t[s],i=a??t;this._pathCache.set(i,r);let h=this._proxyCache.get(i);return h===void 0&&(h=a===void 0?new Proxy(t,n):t,this._proxyCache.set(i,h)),h}getPath(t){return this.isUnsubscribed?void 0:this._pathCache.get(t)}isDetached(t,r){return!Object.is(t,b.get(r,this.getPath(t)))}defineProperty(t,r,n){return Reflect.defineProperty(t,r,n)?(this.isUnsubscribed||(this._getProperties(t)[r]=n),!0):!1}setProperty(t,r,n,s,a){if(!this._equals(a,n)||!(r in t)){const i=this._getOwnPropertyDescriptor(t,r);return i!==void 0&&"set"in i?Reflect.set(t,r,n,s):Reflect.set(t,r,n)}return!0}deleteProperty(t,r,n){if(Reflect.deleteProperty(t,r)){if(!this.isUnsubscribed){const s=this._getDescriptorCache().get(t);s&&(delete s[r],this._pathCache.delete(n))}return!0}return!1}isSameDescriptor(t,r,n){const s=this._getOwnPropertyDescriptor(r,n);return t!==void 0&&s!==void 0&&Object.is(t.value,s.value)&&(t.writable||!1)===(s.writable||!1)&&(t.enumerable||!1)===(s.enumerable||!1)&&(t.configurable||!1)===(s.configurable||!1)&&t.get===s.get&&t.set===s.set}isGetInvariant(t,r){const n=this._getOwnPropertyDescriptor(t,r);return n!==void 0&&n.configurable!==!0&&n.writable!==!0}unsubscribe(){this._descriptorCache=null,this._pathCache=null,this._proxyCache=null,this.isUnsubscribed=!0}}function B(e){return toString.call(e)==="[object Object]"}function H(){return!0}function k(e,t){return e.length!==t.length||e.some((r,n)=>t[n]!==r)}const ee=new Set(["hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"]),he=new Set(["concat","includes","indexOf","join","keys","lastIndexOf"]),te={push:H,pop:H,shift:H,unshift:H,copyWithin:k,reverse:k,sort:k,splice:k,flat:k,fill:k},fe=new Set([...ee,...he,...Object.keys(te)]);function L(e,t){if(e.size!==t.size)return!0;for(const r of e)if(!t.has(r))return!0;return!1}const re=["keys","values","entries"],ne=new Set(["has","toString"]),se={add:L,clear:L,delete:L,forEach:L},me=new Set([...ne,...Object.keys(se),...re]);function N(e,t){if(e.size!==t.size)return!0;let r;for(const[n,s]of e)if(r=t.get(n),r!==s||r===void 0&&!t.has(n))return!0;return!1}const ue=new Set([...ne,"get"]),oe={set:N,clear:N,delete:N,forEach:N},Re=new Set([...ue,...Object.keys(oe),...re]);class ${constructor(t,r,n,s){this._path=r,this._isChanged=!1,this._clonedCache=new Set,this._hasOnValidate=s,this._changes=s?[]:null,this.clone=r===void 0?t:this._shallowClone(t)}static isHandledMethod(t){return ee.has(t)}_shallowClone(t){let r=t;if(B(t))r={...t};else if(u(t)||ArrayBuffer.isView(t))r=[...t];else if(t instanceof Date)r=new Date(t);else if(t instanceof Set)r=new Set([...t].map(n=>this._shallowClone(n)));else if(t instanceof Map){r=new Map;for(const[n,s]of t.entries())r.set(n,this._shallowClone(s))}return this._clonedCache.add(r),r}preferredThisArg(t,r,n,s){return t?(u(s)?this._onIsChanged=te[r]:s instanceof Set?this._onIsChanged=se[r]:s instanceof Map&&(this._onIsChanged=oe[r]),s):n}update(t,r,n){const s=b.after(t,this._path);if(r!=="length"){let a=this.clone;b.walk(s,i=>{a!=null&&a[i]&&(this._clonedCache.has(a[i])||(a[i]=this._shallowClone(a[i])),a=a[i])}),this._hasOnValidate&&this._changes.push({path:s,property:r,previous:n}),a!=null&&a[r]&&(a[r]=n)}this._isChanged=!0}undo(t){let r;for(let n=this._changes.length-1;n!==-1;n--)r=this._changes[n],b.get(t,r.path)[r.property]=r.previous}isChanged(t){return this._onIsChanged===void 0?this._isChanged:this._onIsChanged(this.clone,t)}isPathApplicable(t){return b.isRootPath(this._path)||b.isSubPath(t,this._path)}}class j extends ${static isHandledMethod(t){return fe.has(t)}}class be extends ${undo(t){t.setTime(this.clone.getTime())}isChanged(t,r){return!r(this.clone.valueOf(),t.valueOf())}}class K extends ${static isHandledMethod(t){return me.has(t)}undo(t){for(const r of this.clone)t.add(r);for(const r of t)this.clone.has(r)||t.delete(r)}}class Y extends ${static isHandledMethod(t){return Re.has(t)}undo(t){for(const[r,n]of this.clone.entries())t.set(r,n);for(const r of t.keys())this.clone.has(r)||t.delete(r)}}class qe extends ${constructor(t,r,n,s){super(void 0,r,n,s),this._argument1=n[0],this._weakValue=t.has(this._argument1)}isChanged(t){return this._weakValue!==t.has(this._argument1)}undo(t){this._weakValue&&!t.has(this._argument1)?t.add(this._argument1):t.delete(this._argument1)}}class we extends ${constructor(t,r,n,s){super(void 0,r,n,s),this._weakKey=n[0],this._weakHas=t.has(this._weakKey),this._weakValue=t.get(this._weakKey)}isChanged(t){return this._weakValue!==t.get(this._weakKey)}undo(t){const r=t.has(this._weakKey);this._weakHas&&!r?t.set(this._weakKey,this._weakValue):!this._weakHas&&r?t.delete(this._weakKey):this._weakValue!==t.get(this._weakKey)&&t.set(this._weakKey,this._weakValue)}}class v{constructor(t){this._stack=[],this._hasOnValidate=t}static isHandledType(t){return B(t)||u(t)||Q(t)}static isHandledMethod(t,r){return B(t)?$.isHandledMethod(r):u(t)?j.isHandledMethod(r):t instanceof Set?K.isHandledMethod(r):t instanceof Map?Y.isHandledMethod(r):Q(t)}get isCloning(){return this._stack.length>0}start(t,r,n){let s=$;u(t)?s=j:t instanceof Date?s=be:t instanceof Set?s=K:t instanceof Map?s=Y:t instanceof WeakSet?s=qe:t instanceof WeakMap&&(s=we),this._stack.push(new s(t,r,n,this._hasOnValidate))}update(t,r,n){this._stack.at(-1).update(t,r,n)}preferredThisArg(t,r,n){const{name:s}=t,a=v.isHandledMethod(n,s);return this._stack.at(-1).preferredThisArg(a,s,r,n)}isChanged(t,r,n){return this._stack.at(-1).isChanged(t,r,n)}isPartOfClone(t){return this._stack.at(-1).isPathApplicable(t)}undo(t){this._previousClone!==void 0&&this._previousClone.undo(t)}stop(){return this._previousClone=this._stack.pop(),this._previousClone.clone}}const Se={equals:Object.is,isShallow:!1,pathAsArray:!1,ignoreSymbols:!1,ignoreUnderscores:!1,ignoreDetached:!1,details:!1},V=(e,t,r={})=>{r={...Se,...r};const n=Symbol("ProxyTarget"),{equals:s,isShallow:a,ignoreDetached:i,details:h}=r,p=new le(s),q=typeof r.onValidate=="function",f=new v(q),R=(o,c,d,l,m)=>!q||f.isCloning||r.onValidate(b.concat(p.getPath(o),c),d,l,m)===!0,S=(o,c,d,l)=>{!z(p,r,c)&&!(i&&p.isDetached(o,e))&&A(p.getPath(o),c,d,l)},A=(o,c,d,l,m)=>{f.isCloning&&f.isPartOfClone(o)?f.update(o,c,l):t(b.concat(o,c),d,l,m)},C=o=>o&&(o[n]??o),T=(o,c,d,l)=>{if(ie(o)||d==="constructor"||a&&!v.isHandledMethod(c,d)||z(p,r,d)||p.isGetInvariant(c,d)||i&&p.isDetached(c,e))return o;l===void 0&&(l=p.getPath(c));const m=b.concat(l,d),w=p.getPath(o);return w&&ae(m,w)?p.getProxy(o,w,E,n):p.getProxy(o,m,E,n)},ae=(o,c)=>{if(M(o)||o.length<=c.length||u(c)&&c.length===0)return!1;const d=u(o)?o:o.split(_),l=u(c)?c:c.split(_);return d.length<=l.length?!1:!l.some((m,w)=>m!==d[w])},E={get(o,c,d){if(M(c)){if(c===n||c===F)return o;if(c===Z&&!p.isUnsubscribed&&p.getPath(o).length===0)return p.unsubscribe(),o}const l=Q(o)?Reflect.get(o,c):Reflect.get(o,c,d);return T(l,o,c)},set(o,c,d,l){d=C(d);const m=o[n]??o,w=m[c];if(s(w,d)&&c in o)return!0;const g=R(o,c,d,w);return g&&p.setProperty(m,c,d,l,w)?(S(o,c,o[c],w),!0):!g},defineProperty(o,c,d){if(!p.isSameDescriptor(d,o,c)){const l=o[c];R(o,c,d.value,l)&&p.defineProperty(o,c,d,l)&&S(o,c,d.value,l)}return!0},deleteProperty(o,c){if(!Reflect.has(o,c))return!0;const d=Reflect.get(o,c),l=R(o,c,void 0,d);return l&&p.deleteProperty(o,c,d)?(S(o,c,void 0,d),!0):!l},apply(o,c,d){const l=c[n]??c;if(p.isUnsubscribed)return Reflect.apply(o,l,d);if((h===!1||h!==!0&&!h.includes(o.name))&&v.isHandledType(l)){let m=b.initial(p.getPath(o));const w=v.isHandledMethod(l,o.name);f.start(l,m,d);let g=Reflect.apply(o,f.preferredThisArg(o,c,l),w?d.map(I=>C(I)):d);const ce=f.isChanged(l,s),U=f.stop();if(v.isHandledType(g)&&w&&(c instanceof Map&&o.name==="get"&&(m=b.concat(m,d[0])),g=p.getProxy(g,m,E)),ce){const I={name:o.name,args:d,result:g},W=f.isCloning?b.initial(m):m,G=f.isCloning?b.last(m):"";R(b.get(e,W),G,l,U,I)?A(W,G,l,U,I):f.undo(l)}return(c instanceof Map||c instanceof Set)&&pe(g)?de(g,o,c,m,T):g}return Reflect.apply(o,c,d)}},P=p.getProxy(e,r.pathAsArray?[]:"",E);return t=t.bind(P),q&&(r.onValidate=r.onValidate.bind(P)),P};V.target=e=>(e==null?void 0:e[F])??e;V.unsubscribe=e=>(e==null?void 0:e[Z])??e;const y=e=>e.split(".").slice(0,3).reverse().join("."),ge=e=>Array(4).fill(0).map((r,n)=>256-2**(8-Math.min(8,Math.max(0,e-n*8)))).join("."),ye=e=>{const t=e.split(".").map(Number),r=t[3]+3;return t[3]=r,t.join(".")},x=e=>e.split(".")[3],_e=({devices:e})=>`
<p>Запуск ISP</p>
...
ip -br a
ping -c 1 ${e.isp.interfaces.hqRtr.ip}
ping -c 1 8.8.8.8
</code></pre></p>
...
systemctl restart network
ip -br a
ping -c 1 ${e.isp.interfaces.brRtr.ip}
ping -c 1 8.8.8.8
</code></pre></p>
<p>Устанавливаем NetworkManager</p>
<p><pre><code>apt-get update
...
systemctl restart network
ip -br a
ping -c 1 ${e.brRtr.interfaces.brSrv.ip}
ping -c 1 8.8.8.8
</code></pre></p>
<br>
<p>Запуск HQ-SRV</p>
...
systemctl restart network
ip -br a
ping -c 1 ${e.hqSrv.interfaces.hqRtr.gateway}
ping -c 1 8.8.8.8
</code></pre></p>
<br>
<h3>Задание 3</h3>
...
ovs-vsctl add-port HQ-SW ${e.hqRtr.interfaces.hqSrv.name} tag=100 -- set interface ${e.hqRtr.interfaces.hqSrv.name} type=internal
ovs-vsctl add-port HQ-SW ${e.hqRtr.interfaces.hqCli.name} tag=200 -- set interface ${e.hqRtr.interfaces.hqCli.name} type=internal
ovs-vsctl add-port HQ-SW ${e.hqRtr.interfaces.vlan999.name} tag=999 -- set interface ${e.hqRtr.interfaces.vlan999.name} type=internal
mkdir /etc/net/ifaces/${e.hqRtr.interfaces.hqSrv.name}
mkdir /etc/net/ifaces/${e.hqRtr.interfaces.hqCli.name}
mkdir /etc/net/ifaces/${e.hqRtr.interfaces.vlan999.name}
cp /etc/net/ifaces/ens18/options /etc/net/ifaces/${e.hqRtr.interfaces.hqSrv.name}/options
cp /etc/net/ifaces/ens18/options /etc/net/ifaces/${e.hqRtr.interfaces.hqCli.name}/options
cp /etc/net/ifaces/ens18/options /etc/net/ifaces/${e.hqRtr.interfaces.vlan999.name}/options
echo '${e.hqRtr.interfaces.hqSrv.ip}/${e.hqRtr.interfaces.hqSrv.mask}' >> /etc/net/ifaces/${e.hqRtr.interfaces.hqSrv.name}/ipv4address
echo '${e.hqRtr.interfaces.hqCli.ip}/${e.hqRtr.interfaces.hqCli.mask}' >> /etc/net/ifaces/${e.hqRtr.interfaces.hqCli.name}/ipv4address
echo '${e.hqRtr.interfaces.vlan999.ip}/${e.hqRtr.interfaces.vlan999.mask}' >> /etc/net/ifaces/${e.hqRtr.interfaces.vlan999.name}/ipv4address
systemctl restart network
ip -br a
</code></pre>
<br>
...
zone ${y(e.hqRtr.interfaces.hqSrv.netAddress)}.in-addr.arpa {
&#9;primary ${e.hqSrv.interfaces.hqRtr.ip};
}

zone ${y(e.hqRtr.interfaces.hqCli.netAddress)}.in-addr.arpa {
&#9;primary ${e.hqSrv.interfaces.hqRtr.ip};
}
...
<p><pre><code>@&#9;IN&#9;SOA&#9;${y(e.hqRtr.interfaces.hqSrv.netAddress)}.in-addr.arpa. root.${y(e.hqRtr.interfaces.hqSrv.netAddress)}.in-addr.arpa. (</code></pre></p>
<br>
<pre><code>&#9;&#9;&#9;)</code></pre>
<pre><code>&#9;IN&#9;NS&#9;${y(e.hqRtr.interfaces.hqSrv.netAddress)}.in-addr.arpa.
&#9;IN&#9;A&#9;${e.hqSrv.interfaces.hqRtr.ip}
${x(e.hqSrv.interfaces.hqRtr.ip)}&#9;IN&#9;PTR&#9;hq-srv.au-team.irpo.
${x(e.hqRtr.interfaces.hqSrv.ip)}&#9;IN&#9;PTR&#9;hq-rtr.au-team.irpo.
</code></pre>
<br>
<p><code>cp zone/100.db zone/200.db</code></p>
<p><code>vim zone/200.db</code></p>
<p>Убираем лишнее и пишем основные моменты:</p>
<p><pre><code>@&#9;IN&#9;SOA&#9;${y(e.hqRtr.interfaces.hqCli.netAddress)}.in-addr.arpa. root.${y(e.hqRtr.interfaces.hqCli.netAddress)}.in-addr.arpa. (</code></pre></p>
<br>
<p><pre><code>&#9;&#9;&#9;)</code></pre></p>
<p><pre><code>&#9;IN&#9;NS&#9;${y(e.hqRtr.interfaces.hqCli.netAddress)}.in-addr.arpa.
&#9;IN&#9;A&#9;${e.hqSrv.interfaces.hqRtr.ip}
${x(e.hqCli.interfaces.hqRtr.ip)}&#9;IN&#9;PTR&#9;hq-cli.au-team.irpo.
${x(e.hqRtr.interfaces.hqCli.ip)}&#9;IN&#9;PTR&#9;hq-rtr.au-team.irpo.
</code></pre></p>
<br>
...
<p>добавляем второй строкой <code>/raid5/nfs ${e.hqCli.interfaces.hqRtr.ip}(rw,sync,no_subtree_check)</code></p>
<p>сохраняем</p>
...
hq-cli ansible_host=${e.hqCli.interfaces.hqRtr.ip} ansible_connection=local
hq-rtr ansible_host=${e.hqRtr.interfaces.hqSrv.ip} ansible_connection=local
br-rtr ansible_host=${e.brRtr.interfaces.brSrv.ip} ansible_connection=local
</code></pre></p>
<p>проверка</p>
...
<h3>Задание 6</h3>
<p>HQ-RTR</p>
<p><pre><code>iptables -t nat -A PREROUTING -p tcp --dport 22 -j DNAT --to-destination ${e.hqSrv.interfaces.hqRtr.ip}:2024
iptables-save >> /etc/sysconfig/iptables
</code></pre></p>
<p>BR-RTR</p>
<p><pre><code>iptables -t nat -A PREROUTING -p tcp --dport 80 -j DNAT --to-destination ${e.brSrv.interfaces.brRtr.ip}:8080
iptables -t nat -A PREROUTING -p tcp --dport 22 -j DNAT --to-destination ${e.brSrv.interfaces.brRtr.ip}:2024
iptables-save >> /etc/sysconfig/iptables
</code></pre></p>
<br>
<h3>Задание 7</h3>
...
<br>
`,$e=(e,{devices:t})=>{const r=document.createElement("table"),n=document.createElement("thead");n.innerHTML=`
    <tr>
  ...
  `,r.appendChild(n);const s=document.createElement("tbody");Object.values(t).forEach(({name:a,interfaces:i})=>{const h=Object.values(i);if(!h.length)return;const p=document.createElement("tr");p.innerHTML=`
      ...
      <td>${h[0].mask}</td>
      <td>${h[0].gateway}</td>
    `,s.appendChild(p);for(let q=1;q<h.length;q+=1){const f=h[q],R=document.createElement("tr");R.innerHTML=`
        <td>${f.destination||"-"}</td>
        <td>${f.ip}</td>
        <td>${f.mask}</td>
        <td>${f.gateway}</td>
      `,s.appendChild(R)}}),r.appendChild(s),e.ipTableContainer.innerHTML="",e.ipTableContainer.appendChild(r)},ve=(e,t)=>{const r=_e(t);e.textContainer.innerHTML=r,document.querySelectorAll("code").forEach(n=>{const s=document.createElement("span");s.className="code-wrapper";const a=document.createElement("div");a.className="code-copy-toast",a.textContent="Скопировано!",n.parentNode.insertBefore(s,n),s.appendChild(n),s.appendChild(a),n.style.cursor="pointer",n.title="Кликни, чтобы скопировать",n.addEventListener("click",()=>{navigator.clipboard.writeText(n.innerText).then(()=>{a.classList.add("show"),setTimeout(()=>a.classList.remove("show"),300)})})})},ke=(e,t)=>(r,n)=>{switch(r){case"devices":$e(e,t),ve(e,t);break}};function Ae(e){const t=new Set;return Object.values(e).forEach(r=>{Object.values(r.interfaces).forEach(({netAddress:n,netName:s,mask:a})=>{s!=="external"&&t.add(JSON.stringify({netAddress:n,netName:s,mask:a}))})}),Array.from(t).map(r=>JSON.parse(r))}function Ce(e,t){const r=document.createElement("form");r.id="network-form",r.innerHTML="<h3>Настройки сетей</h3>",e.forEach(p=>{const q=document.createElement("div");q.className="network-input";const f=document.createElement("label");f.textContent=`Сеть ${p.netName}:`;const R=document.createElement("input");R.type="text",R.placeholder=`Адрес сети (${p.netAddress})`,R.dataset.netAddress=p.netAddress;const S=document.createElement("input");S.type="text",S.placeholder=`Маска (${p.mask})`,S.dataset.netAddress=p.netAddress,q.append(f,R,S),r.append(q)});const n=document.createElement("div");n.innerHTML="<h4>Настройки названий VLAN</h4>";const s=document.createElement("input");s.type="text",s.placeholder="Название интерфейса vlan100",s.id="vlan100-name",s.value="vlan100";const a=document.createElement("input");a.type="text",a.placeholder="Название интерфейса vlan200",a.id="vlan200-name",a.value="vlan200";const i=document.createElement("input");i.type="text",i.placeholder="Название интерфейса vlan999",i.id="vlan999-name",i.value="vlan999",n.append(s,a,i),r.append(n);const h=document.createElement("button");h.type="button",h.textContent="Обновить",r.append(h),t.innerHTML="",t.append(r)}function Te(){const e=document.querySelectorAll("#network-form input"),t={},r={};return e.forEach(n=>{const{netAddress:s}=n.dataset;n.id==="vlan100-name"?r.vlan100=n.value.trim()||"vlan100":n.id==="vlan200-name"?r.vlan200=n.value.trim()||"vlan200":n.id==="vlan999-name"&&(r.vlan999=n.value.trim()||"vlan999"),s&&(t[s]||(t[s]={}),n.placeholder.includes("Адрес сети")?t[s].address=n.value.trim():t[s].mask=n.value.trim())}),{networkData:t,vlanNames:r}}function O(e){return e.split(".").reduce((t,r)=>(t<<8)+parseInt(r,10),0)>>>0}function J(e){return[e>>>24&255,e>>>16&255,e>>>8&255,e&255].join(".")}function X(e,t){const r=t?4294967295<<32-t:0;return e&~r}function Ee(e,t){const r=JSON.parse(JSON.stringify(e));return Object.entries(t).forEach(([n,s])=>{if(!s.address||!s.mask)return;const a=O(s.address),i=parseInt(s.mask,10);Object.values(r).forEach(h=>{Object.values(h.interfaces).forEach(p=>{if(p.netAddress===n){const q=O(p.ip),f=parseInt(p.mask,10),R=X(q,f),S=a&4294967295<<32-i|R;if(p.ip=J(S),p.mask=s.mask.toString(),p.netAddress=s.address,p.gateway!=="-"){const A=O(p.gateway),C=X(A,f),T=a&4294967295<<32-i|C;p.gateway=J(T)}}})})}),r}function Ie(e,t){var n;const r=JSON.parse(JSON.stringify(e));return(n=r.hqRtr)!=null&&n.interfaces&&(r.hqRtr.interfaces.hqSrv&&t.vlan100&&(r.hqRtr.interfaces.hqSrv.name=t.vlan100),r.hqRtr.interfaces.hqCli&&t.vlan200&&(r.hqRtr.interfaces.hqCli.name=t.vlan200),r.hqRtr.interfaces.vlan999&&t.vlan999&&(r.hqRtr.interfaces.vlan999.name=t.vlan999)),r}const D={isp:{name:"ISP",interfaces:{external:{name:"ens18",ip:"<ВНЕШНИЙ>",mask:"24",gateway:"<ВНЕШНИЙ>",destination:"Интернет",netAddress:"",netName:"external"},hqRtr:{name:"ens19",ip:"172.16.4.1",mask:"28",gateway:"-",destination:"HQ-RTR",netAddress:"172.16.4.0",netName:"ISP-HQ"},brRtr:{name:"ens20",ip:"172.16.5.1",mask:"28",gateway:"-",destination:"BR-RTR",netAddress:"172.16.5.0",netName:"ISP-BR"}}},hqRtr:{name:"HQ-RTR",interfaces:{isp:{name:"ens18",ip:"172.16.4.2",mask:"28",gateway:"172.16.4.1",destination:"ISP",netAddress:"172.16.4.0",netName:"ISP-HQ"},brRtr:{name:"gre1",ip:"10.5.5.1",mask:"30",gateway:"-",destination:"BR-RTR",netAddress:"10.5.5.0",netName:"GRE"},hqSrv:{name:"vlan100",ip:"192.168.100.1",mask:"26",gateway:"-",destination:"HQ-SRV",netAddress:"192.168.100.0",netName:"SRV-Net"},hqCli:{name:"vlan200",ip:"192.168.200.1",mask:"28",gateway:"-",destination:"HQ-CLI",netAddress:"192.168.200.0",netName:"CLI-Net"},vlan999:{name:"vlan999",ip:"192.168.99.1",mask:"29",gateway:"-",destination:"VLAN999 (?)",netAddress:"192.168.99.0",netName:"vlan999"}}},hqSrv:{name:"HQ-SRV",interfaces:{hqRtr:{name:"ens18",ip:"192.168.100.2",mask:"26",gateway:"192.168.100.1",destination:"HQ-RTR",netAddress:"192.168.100.0",netName:"SRV-Net"}}},hqCli:{name:"HQ-CLI",interfaces:{hqRtr:{name:"ens18",ip:"192.168.200.2",mask:"28",gateway:"192.168.200.1",destination:"HQ-RTR",netAddress:"192.168.200.0",netName:"CLI-Net"}}},brRtr:{name:"BR-RTR",interfaces:{isp:{name:"ens18",ip:"172.16.5.2",mask:"28",gateway:"172.16.5.1",destination:"ISP",netAddress:"172.16.5.0",netName:"ISP-BR"},brSrv:{name:"ens19",ip:"192.168.0.1",mask:"27",gateway:"-",destination:"BR-SRV",netAddress:"192.168.0.0",netName:"BR-Net"},hqRtr:{name:"gre1",ip:"10.5.5.2",mask:"30",gateway:"-",destination:"HQ-RTR",netAddress:"10.5.5.0",netName:"GRE"}}},brSrv:{name:"BR-SRV",interfaces:{brRtr:{name:"ens18",ip:"192.168.0.2",mask:"27",gateway:"192.168.0.1",destination:"BR-RTR",netAddress:"192.168.0.0",netName:"BR-Net"}}}},He=()=>{const e={ipTableContainer:document.getElementById("ip-table-container"),textContainer:document.getElementById("text-container"),networkFormContainer:document.getElementById("network-form-container")},t={devices:[]},r=V(t,ke(e,t));r.devices=D;const n=Ae(D);Ce(n,e.networkFormContainer),document.querySelector("#network-form button").addEventListener("click",()=>{const{networkData:s,vlanNames:a}=Te();console.log(s,a);let i=Ee(D,s);i=Ie(i,a),console.log(i),r.devices=i})};He();
