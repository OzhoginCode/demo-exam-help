(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const p of s)if(p.type==="childList")for(const a of p.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function r(s){const p={};return s.integrity&&(p.integrity=s.integrity),s.referrerPolicy&&(p.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?p.credentials="include":s.crossOrigin==="anonymous"?p.credentials="omit":p.credentials="same-origin",p}function n(s){if(s.ep)return;s.ep=!0;const p=r(s);fetch(s.href,p)}})();const g=".",I=Symbol("target"),F=Symbol("unsubscribe");function L(e){return e instanceof Date||e instanceof Set||e instanceof Map||e instanceof WeakSet||e instanceof WeakMap||ArrayBuffer.isView(e)}function se(e){return(typeof e=="object"?e===null:typeof e!="function")||e instanceof RegExp}const m=Array.isArray;function M(e){return typeof e=="symbol"}const b={after(e,t){return m(e)?e.slice(t.length):t===""?e:e.slice(t.length+1)},concat(e,t){return m(e)?(e=[...e],t&&e.push(t),e):t&&t.toString!==void 0?(e!==""&&(e+=g),M(t)?e+t.toString():e+t):e},initial(e){if(m(e))return e.slice(0,-1);if(e==="")return e;const t=e.lastIndexOf(g);return t===-1?"":e.slice(0,t)},last(e){if(m(e))return e.at(-1)??"";if(e==="")return e;const t=e.lastIndexOf(g);return t===-1?e:e.slice(t+1)},walk(e,t){if(m(e))for(const r of e)t(r);else if(e!==""){let r=0,n=e.indexOf(g);if(n===-1)t(e);else for(;r<e.length;)n===-1&&(n=e.length),t(e.slice(r,n)),r=n+1,n=e.indexOf(g,r)}},get(e,t){return this.walk(t,r=>{e&&(e=e[r])}),e},isSubPath(e,t){if(m(e)){if(e.length<t.length)return!1;for(let r=0;r<t.length;r++)if(e[r]!==t[r])return!1;return!0}return e.length<t.length?!1:e===t?!0:e.startsWith(t)?e[t.length]===g:!1},isRootPath(e){return m(e)?e.length===0:e===""}};function oe(e){return typeof e=="object"&&typeof e.next=="function"}function ce(e,t,r,n,s){const p=e.next;if(t.name==="entries")e.next=function(){const a=p.call(this);return a.done===!1&&(a.value[0]=s(a.value[0],t,a.value[0],n),a.value[1]=s(a.value[1],t,a.value[0],n)),a};else if(t.name==="values"){const a=r[I].keys();e.next=function(){const d=p.call(this);return d.done===!1&&(d.value=s(d.value,t,a.next().value,n)),d}}else e.next=function(){const a=p.call(this);return a.done===!1&&(a.value=s(a.value,t,a.value,n)),a};return e}function W(e,t,r){return e.isUnsubscribed||t.ignoreSymbols&&M(r)||t.ignoreUnderscores&&r.charAt(0)==="_"||"ignoreKeys"in t&&t.ignoreKeys.includes(r)}class pe{constructor(t){this._equals=t,this._proxyCache=new WeakMap,this._pathCache=new WeakMap,this.isUnsubscribed=!1}_getDescriptorCache(){return this._descriptorCache===void 0&&(this._descriptorCache=new WeakMap),this._descriptorCache}_getProperties(t){const r=this._getDescriptorCache();let n=r.get(t);return n===void 0&&(n={},r.set(t,n)),n}_getOwnPropertyDescriptor(t,r){if(this.isUnsubscribed)return Reflect.getOwnPropertyDescriptor(t,r);const n=this._getProperties(t);let s=n[r];return s===void 0&&(s=Reflect.getOwnPropertyDescriptor(t,r),n[r]=s),s}getProxy(t,r,n,s){if(this.isUnsubscribed)return t;const p=t[s],a=p??t;this._pathCache.set(a,r);let d=this._proxyCache.get(a);return d===void 0&&(d=p===void 0?new Proxy(t,n):t,this._proxyCache.set(a,d)),d}getPath(t){return this.isUnsubscribed?void 0:this._pathCache.get(t)}isDetached(t,r){return!Object.is(t,b.get(r,this.getPath(t)))}defineProperty(t,r,n){return Reflect.defineProperty(t,r,n)?(this.isUnsubscribed||(this._getProperties(t)[r]=n),!0):!1}setProperty(t,r,n,s,p){if(!this._equals(p,n)||!(r in t)){const a=this._getOwnPropertyDescriptor(t,r);return a!==void 0&&"set"in a?Reflect.set(t,r,n,s):Reflect.set(t,r,n)}return!0}deleteProperty(t,r,n){if(Reflect.deleteProperty(t,r)){if(!this.isUnsubscribed){const s=this._getDescriptorCache().get(t);s&&(delete s[r],this._pathCache.delete(n))}return!0}return!1}isSameDescriptor(t,r,n){const s=this._getOwnPropertyDescriptor(r,n);return t!==void 0&&s!==void 0&&Object.is(t.value,s.value)&&(t.writable||!1)===(s.writable||!1)&&(t.enumerable||!1)===(s.enumerable||!1)&&(t.configurable||!1)===(s.configurable||!1)&&t.get===s.get&&t.set===s.set}isGetInvariant(t,r){const n=this._getOwnPropertyDescriptor(t,r);return n!==void 0&&n.configurable!==!0&&n.writable!==!0}unsubscribe(){this._descriptorCache=null,this._pathCache=null,this._proxyCache=null,this.isUnsubscribed=!0}}function P(e){return toString.call(e)==="[object Object]"}function v(){return!0}function _(e,t){return e.length!==t.length||e.some((r,n)=>t[n]!==r)}const J=new Set(["hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"]),ae=new Set(["concat","includes","indexOf","join","keys","lastIndexOf"]),Y={push:v,pop:v,shift:v,unshift:v,copyWithin:_,reverse:_,sort:_,splice:_,flat:_,fill:_},ie=new Set([...J,...ae,...Object.keys(Y)]);function T(e,t){if(e.size!==t.size)return!0;for(const r of e)if(!t.has(r))return!0;return!1}const Z=["keys","values","entries"],X=new Set(["has","toString"]),ee={add:T,clear:T,delete:T,forEach:T},de=new Set([...X,...Object.keys(ee),...Z]);function E(e,t){if(e.size!==t.size)return!0;let r;for(const[n,s]of e)if(r=t.get(n),r!==s||r===void 0&&!t.has(n))return!0;return!1}const le=new Set([...X,"get"]),te={set:E,clear:E,delete:E,forEach:E},fe=new Set([...le,...Object.keys(te),...Z]);class y{constructor(t,r,n,s){this._path=r,this._isChanged=!1,this._clonedCache=new Set,this._hasOnValidate=s,this._changes=s?[]:null,this.clone=r===void 0?t:this._shallowClone(t)}static isHandledMethod(t){return J.has(t)}_shallowClone(t){let r=t;if(P(t))r={...t};else if(m(t)||ArrayBuffer.isView(t))r=[...t];else if(t instanceof Date)r=new Date(t);else if(t instanceof Set)r=new Set([...t].map(n=>this._shallowClone(n)));else if(t instanceof Map){r=new Map;for(const[n,s]of t.entries())r.set(n,this._shallowClone(s))}return this._clonedCache.add(r),r}preferredThisArg(t,r,n,s){return t?(m(s)?this._onIsChanged=Y[r]:s instanceof Set?this._onIsChanged=ee[r]:s instanceof Map&&(this._onIsChanged=te[r]),s):n}update(t,r,n){const s=b.after(t,this._path);if(r!=="length"){let p=this.clone;b.walk(s,a=>{p!=null&&p[a]&&(this._clonedCache.has(p[a])||(p[a]=this._shallowClone(p[a])),p=p[a])}),this._hasOnValidate&&this._changes.push({path:s,property:r,previous:n}),p!=null&&p[r]&&(p[r]=n)}this._isChanged=!0}undo(t){let r;for(let n=this._changes.length-1;n!==-1;n--)r=this._changes[n],b.get(t,r.path)[r.property]=r.previous}isChanged(t){return this._onIsChanged===void 0?this._isChanged:this._onIsChanged(this.clone,t)}isPathApplicable(t){return b.isRootPath(this._path)||b.isSubPath(t,this._path)}}class z extends y{static isHandledMethod(t){return ie.has(t)}}class he extends y{undo(t){t.setTime(this.clone.getTime())}isChanged(t,r){return!r(this.clone.valueOf(),t.valueOf())}}class K extends y{static isHandledMethod(t){return de.has(t)}undo(t){for(const r of this.clone)t.add(r);for(const r of t)this.clone.has(r)||t.delete(r)}}class j extends y{static isHandledMethod(t){return fe.has(t)}undo(t){for(const[r,n]of this.clone.entries())t.set(r,n);for(const r of t.keys())this.clone.has(r)||t.delete(r)}}class ue extends y{constructor(t,r,n,s){super(void 0,r,n,s),this._argument1=n[0],this._weakValue=t.has(this._argument1)}isChanged(t){return this._weakValue!==t.has(this._argument1)}undo(t){this._weakValue&&!t.has(this._argument1)?t.add(this._argument1):t.delete(this._argument1)}}class me extends y{constructor(t,r,n,s){super(void 0,r,n,s),this._weakKey=n[0],this._weakHas=t.has(this._weakKey),this._weakValue=t.get(this._weakKey)}isChanged(t){return this._weakValue!==t.get(this._weakKey)}undo(t){const r=t.has(this._weakKey);this._weakHas&&!r?t.set(this._weakKey,this._weakValue):!this._weakHas&&r?t.delete(this._weakKey):this._weakValue!==t.get(this._weakKey)&&t.set(this._weakKey,this._weakValue)}}class A{constructor(t){this._stack=[],this._hasOnValidate=t}static isHandledType(t){return P(t)||m(t)||L(t)}static isHandledMethod(t,r){return P(t)?y.isHandledMethod(r):m(t)?z.isHandledMethod(r):t instanceof Set?K.isHandledMethod(r):t instanceof Map?j.isHandledMethod(r):L(t)}get isCloning(){return this._stack.length>0}start(t,r,n){let s=y;m(t)?s=z:t instanceof Date?s=he:t instanceof Set?s=K:t instanceof Map?s=j:t instanceof WeakSet?s=ue:t instanceof WeakMap&&(s=me),this._stack.push(new s(t,r,n,this._hasOnValidate))}update(t,r,n){this._stack.at(-1).update(t,r,n)}preferredThisArg(t,r,n){const{name:s}=t,p=A.isHandledMethod(n,s);return this._stack.at(-1).preferredThisArg(p,s,r,n)}isChanged(t,r,n){return this._stack.at(-1).isChanged(t,r,n)}isPartOfClone(t){return this._stack.at(-1).isPathApplicable(t)}undo(t){this._previousClone!==void 0&&this._previousClone.undo(t)}stop(){return this._previousClone=this._stack.pop(),this._previousClone.clone}}const be={equals:Object.is,isShallow:!1,pathAsArray:!1,ignoreSymbols:!1,ignoreUnderscores:!1,ignoreDetached:!1,details:!1},N=(e,t,r={})=>{r={...be,...r};const n=Symbol("ProxyTarget"),{equals:s,isShallow:p,ignoreDetached:a,details:d}=r,f=new pe(s),S=typeof r.onValidate=="function",u=new A(S),$=(o,c,i,l,h)=>!S||u.isCloning||r.onValidate(b.concat(f.getPath(o),c),i,l,h)===!0,H=(o,c,i,l)=>{!W(f,r,c)&&!(a&&f.isDetached(o,e))&&D(f.getPath(o),c,i,l)},D=(o,c,i,l,h)=>{u.isCloning&&u.isPartOfClone(o)?u.update(o,c,l):t(b.concat(o,c),i,l,h)},x=o=>o&&(o[n]??o),B=(o,c,i,l)=>{if(se(o)||i==="constructor"||p&&!A.isHandledMethod(c,i)||W(f,r,i)||f.isGetInvariant(c,i)||a&&f.isDetached(c,e))return o;l===void 0&&(l=f.getPath(c));const h=b.concat(l,i),R=f.getPath(o);return R&&re(h,R)?f.getProxy(o,R,k,n):f.getProxy(o,h,k,n)},re=(o,c)=>{if(M(o)||o.length<=c.length||m(c)&&c.length===0)return!1;const i=m(o)?o:o.split(g),l=m(c)?c:c.split(g);return i.length<=l.length?!1:!l.some((h,R)=>h!==i[R])},k={get(o,c,i){if(M(c)){if(c===n||c===I)return o;if(c===F&&!f.isUnsubscribed&&f.getPath(o).length===0)return f.unsubscribe(),o}const l=L(o)?Reflect.get(o,c):Reflect.get(o,c,i);return B(l,o,c)},set(o,c,i,l){i=x(i);const h=o[n]??o,R=h[c];if(s(R,i)&&c in o)return!0;const q=$(o,c,i,R);return q&&f.setProperty(h,c,i,l,R)?(H(o,c,o[c],R),!0):!q},defineProperty(o,c,i){if(!f.isSameDescriptor(i,o,c)){const l=o[c];$(o,c,i.value,l)&&f.defineProperty(o,c,i,l)&&H(o,c,i.value,l)}return!0},deleteProperty(o,c){if(!Reflect.has(o,c))return!0;const i=Reflect.get(o,c),l=$(o,c,void 0,i);return l&&f.deleteProperty(o,c,i)?(H(o,c,void 0,i),!0):!l},apply(o,c,i){const l=c[n]??c;if(f.isUnsubscribed)return Reflect.apply(o,l,i);if((d===!1||d!==!0&&!d.includes(o.name))&&A.isHandledType(l)){let h=b.initial(f.getPath(o));const R=A.isHandledMethod(l,o.name);u.start(l,h,i);let q=Reflect.apply(o,u.preferredThisArg(o,c,l),R?i.map(C=>x(C)):i);const ne=u.isChanged(l,s),Q=u.stop();if(A.isHandledType(q)&&R&&(c instanceof Map&&o.name==="get"&&(h=b.concat(h,i[0])),q=f.getProxy(q,h,k)),ne){const C={name:o.name,args:i,result:q},V=u.isCloning?b.initial(h):h,U=u.isCloning?b.last(h):"";$(b.get(e,V),U,l,Q,C)?D(V,U,l,Q,C):u.undo(l)}return(c instanceof Map||c instanceof Set)&&oe(q)?ce(q,o,c,h,B):q}return Reflect.apply(o,c,i)}},O=f.getProxy(e,r.pathAsArray?[]:"",k);return t=t.bind(O),S&&(r.onValidate=r.onValidate.bind(O)),O};N.target=e=>(e==null?void 0:e[I])??e;N.unsubscribe=e=>(e==null?void 0:e[F])??e;const w=e=>e.split(".").slice(0,3).reverse().join("."),Re=e=>Array(4).fill(0).map((r,n)=>256-2**(8-Math.min(8,Math.max(0,e-n*8)))).join("."),Se=e=>{const t=e.split(".").map(Number),r=t[3]+3;return t[3]=r,t.join(".")},qe=({devices:e})=>`
<p>Запуск ISP</p>
...
<p><code>reboot</code></p>
<br>
`,we=(e,{devices:t})=>{const r=document.createElement("table"),n=document.createElement("thead");n.innerHTML=`
    <tr>
  ...
  `,r.appendChild(n);const s=document.createElement("tbody");Object.values(t).forEach(({name:p,interfaces:a})=>{const d=Object.values(a);if(!d.length)return;const f=document.createElement("tr");f.innerHTML=`
    ...
    `,s.appendChild(f);for(let S=1;S<d.length;S+=1){const u=d[S],$=document.createElement("tr");$.innerHTML=`
        ...
        <td>${u.mask}</td>
        <td>${u.gateway}</td>
      `,s.appendChild($)}}),r.appendChild(s),e.ipTableContainer.innerHTML="",e.ipTableContainer.appendChild(r)},ge=(e,t)=>{const r=qe(t);e.textContainer.innerHTML=r,document.querySelectorAll("code").forEach(n=>{const s=document.createElement("span");s.className="code-wrapper";const p=document.createElement("div");p.className="code-copy-toast",p.textContent="Скопировано!",n.parentNode.insertBefore(s,n),s.appendChild(n),s.appendChild(p),n.style.cursor="pointer",n.title="Кликни, чтобы скопировать",n.addEventListener("click",()=>{navigator.clipboard.writeText(n.innerText).then(()=>{p.classList.add("show"),setTimeout(()=>p.classList.remove("show"),300)})})})},ye=(e,t)=>(r,n)=>{switch(r){case"devices":we(e,t),ge(e,t);break}};function $e(e){const t=new Set;return Object.values(e).forEach(r=>{Object.values(r.interfaces).forEach(n=>{n.netAddress&&!n.netAddress.startsWith("<")&&t.add(n.netAddress)})}),Array.from(t)}function Ae(e,t){const r=document.createElement("form");r.id="network-form",r.innerHTML="<h3>Настройки сетей</h3>",e.forEach(s=>{const p=document.createElement("div");p.className="network-input";const a=document.createElement("label");a.textContent=`Сеть ${s}:`;const d=document.createElement("input");d.type="text",d.placeholder="Базовый адрес (напр. 192.168.0)",d.dataset.network=s;const f=document.createElement("input");f.type="text",f.placeholder="Маска (напр. 24)",f.dataset.network=s,p.append(a,d,f),r.append(p)});const n=document.createElement("button");n.type="button",n.textContent="Обновить",r.append(n),t.innerHTML="",t.append(r)}function _e(){const e=document.querySelectorAll("#network-form input"),t={};return e.forEach(r=>{const{network:n}=r.dataset;t[n]||(t[n]={}),r.placeholder.includes("Базовый")?t[n].base=r.value.trim():t[n].mask=r.value.trim()}),t}function ke(e,t){const r=JSON.parse(JSON.stringify(e));return Object.entries(t).forEach(([n,{base:s,mask:p}])=>{!s||!p||Object.values(r).forEach(a=>{Object.values(a.interfaces).forEach(d=>{if(d.netAddress===n){d.mask=p;const[f]=d.ip.split(".").slice(-1);if(d.ip=`${s}.${f}`,d.netAddress=`${s}.0`,d.gateway!=="-"){const S=d.gateway.split(".");S.splice(0,3,...s.split(".")),d.gateway=S.join(".")}}})})}),r}const G={isp:{name:"ISP",interfaces:{external:{name:"ens18",ip:"<ВНЕШНИЙ>",mask:"24",gateway:"<ВНЕШНИЙ>",destination:"Интернет",netAddress:""},hqRtr:{name:"ens19",ip:"172.16.4.1",mask:"28",gateway:"-",destination:"HQ-RTR",netAddress:"172.16.4.0"},brRtr:{name:"ens20",ip:"172.16.5.1",mask:"28",gateway:"-",destination:"BR-RTR",netAddress:"172.16.5.0"}}},hqRtr:{name:"HQ-RTR",interfaces:{isp:{name:"ens18",ip:"172.16.4.2",mask:"28",gateway:"172.16.4.1",destination:"ISP",netAddress:"172.16.4.0"},brRtr:{name:"gre1",ip:"10.5.5.1",mask:"30",gateway:"-",destination:"BR-RTR",netAddress:"10.5.5.0"},hqCli:{name:"VLAN100",ip:"192.168.100.1",mask:"28",gateway:"-",destination:"HQ-SRV",netAddress:"192.168.100.0"},hqSrv:{name:"VLAN200",ip:"192.168.200.1",mask:"28",gateway:"-",destination:"HQ-CLI",netAddress:"192.168.200.0"},vlan999:{name:"VLAN999",ip:"192.168.99.1",mask:"29",gateway:"-",destination:"VLAN999 (?)",netAddress:"192.168.99.0"}}},hqSrv:{name:"HQ-SRV",interfaces:{hqRtr:{name:"ens18",ip:"192.168.100.2",mask:"28",gateway:"192.168.100.1",destination:"HQ-RTR",netAddress:"192.168.100.0"}}},hqCli:{name:"HQ-CLI",interfaces:{hqRtr:{name:"ens18",ip:"192.168.200.2",mask:"28",gateway:"192.168.200.1",destination:"HQ-RTR",netAddress:"192.168.200.0"}}},brRtr:{name:"BR-RTR",interfaces:{isp:{name:"ens18",ip:"172.16.5.2",mask:"28",gateway:"172.16.5.1",destination:"ISP",netAddress:"172.16.5.0"},brSrv:{name:"ens19",ip:"192.168.0.1",mask:"28",gateway:"-",destination:"BR-SRV",netAddress:"192.168.0.0"},hqRtr:{name:"gre1",ip:"10.5.5.2",mask:"30",gateway:"-",destination:"HQ-RTR",netAddress:"10.5.5.0"}}},brSrv:{name:"BR-SRV",interfaces:{brRtr:{name:"ens18",ip:"192.168.0.2",mask:"28",gateway:"192.168.0.1",destination:"BR-RTR",netAddress:"192.168.0.0"}}}},Ce=()=>{const e={ipTableContainer:document.getElementById("ip-table-container"),textContainer:document.getElementById("text-container"),networkFormContainer:document.getElementById("network-form-container")},t={devices:[]},r=N(t,ye(e,t));r.devices=G;const n=JSON.parse(JSON.stringify(G)),s=$e(n);Ae(s,e.networkFormContainer),document.querySelector("#network-form button").addEventListener("click",()=>{const p=_e(),a=ke(n,p);console.log(a),r.devices=a})};Ce();
