(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const p of o)if(p.type==="childList")for(const a of p.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function r(o){const p={};return o.integrity&&(p.integrity=o.integrity),o.referrerPolicy&&(p.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?p.credentials="include":o.crossOrigin==="anonymous"?p.credentials="omit":p.credentials="same-origin",p}function n(o){if(o.ep)return;o.ep=!0;const p=r(o);fetch(o.href,p)}})();const g=".",I=Symbol("target"),F=Symbol("unsubscribe");function L(e){return e instanceof Date||e instanceof Set||e instanceof Map||e instanceof WeakSet||e instanceof WeakMap||ArrayBuffer.isView(e)}function oe(e){return(typeof e=="object"?e===null:typeof e!="function")||e instanceof RegExp}const m=Array.isArray;function M(e){return typeof e=="symbol"}const R={after(e,t){return m(e)?e.slice(t.length):t===""?e:e.slice(t.length+1)},concat(e,t){return m(e)?(e=[...e],t&&e.push(t),e):t&&t.toString!==void 0?(e!==""&&(e+=g),M(t)?e+t.toString():e+t):e},initial(e){if(m(e))return e.slice(0,-1);if(e==="")return e;const t=e.lastIndexOf(g);return t===-1?"":e.slice(0,t)},last(e){if(m(e))return e.at(-1)??"";if(e==="")return e;const t=e.lastIndexOf(g);return t===-1?e:e.slice(t+1)},walk(e,t){if(m(e))for(const r of e)t(r);else if(e!==""){let r=0,n=e.indexOf(g);if(n===-1)t(e);else for(;r<e.length;)n===-1&&(n=e.length),t(e.slice(r,n)),r=n+1,n=e.indexOf(g,r)}},get(e,t){return this.walk(t,r=>{e&&(e=e[r])}),e},isSubPath(e,t){if(m(e)){if(e.length<t.length)return!1;for(let r=0;r<t.length;r++)if(e[r]!==t[r])return!1;return!0}return e.length<t.length?!1:e===t?!0:e.startsWith(t)?e[t.length]===g:!1},isRootPath(e){return m(e)?e.length===0:e===""}};function se(e){return typeof e=="object"&&typeof e.next=="function"}function ce(e,t,r,n,o){const p=e.next;if(t.name==="entries")e.next=function(){const a=p.call(this);return a.done===!1&&(a.value[0]=o(a.value[0],t,a.value[0],n),a.value[1]=o(a.value[1],t,a.value[0],n)),a};else if(t.name==="values"){const a=r[I].keys();e.next=function(){const d=p.call(this);return d.done===!1&&(d.value=o(d.value,t,a.next().value,n)),d}}else e.next=function(){const a=p.call(this);return a.done===!1&&(a.value=o(a.value,t,a.value,n)),a};return e}function W(e,t,r){return e.isUnsubscribed||t.ignoreSymbols&&M(r)||t.ignoreUnderscores&&r.charAt(0)==="_"||"ignoreKeys"in t&&t.ignoreKeys.includes(r)}class pe{constructor(t){this._equals=t,this._proxyCache=new WeakMap,this._pathCache=new WeakMap,this.isUnsubscribed=!1}_getDescriptorCache(){return this._descriptorCache===void 0&&(this._descriptorCache=new WeakMap),this._descriptorCache}_getProperties(t){const r=this._getDescriptorCache();let n=r.get(t);return n===void 0&&(n={},r.set(t,n)),n}_getOwnPropertyDescriptor(t,r){if(this.isUnsubscribed)return Reflect.getOwnPropertyDescriptor(t,r);const n=this._getProperties(t);let o=n[r];return o===void 0&&(o=Reflect.getOwnPropertyDescriptor(t,r),n[r]=o),o}getProxy(t,r,n,o){if(this.isUnsubscribed)return t;const p=t[o],a=p??t;this._pathCache.set(a,r);let d=this._proxyCache.get(a);return d===void 0&&(d=p===void 0?new Proxy(t,n):t,this._proxyCache.set(a,d)),d}getPath(t){return this.isUnsubscribed?void 0:this._pathCache.get(t)}isDetached(t,r){return!Object.is(t,R.get(r,this.getPath(t)))}defineProperty(t,r,n){return Reflect.defineProperty(t,r,n)?(this.isUnsubscribed||(this._getProperties(t)[r]=n),!0):!1}setProperty(t,r,n,o,p){if(!this._equals(p,n)||!(r in t)){const a=this._getOwnPropertyDescriptor(t,r);return a!==void 0&&"set"in a?Reflect.set(t,r,n,o):Reflect.set(t,r,n)}return!0}deleteProperty(t,r,n){if(Reflect.deleteProperty(t,r)){if(!this.isUnsubscribed){const o=this._getDescriptorCache().get(t);o&&(delete o[r],this._pathCache.delete(n))}return!0}return!1}isSameDescriptor(t,r,n){const o=this._getOwnPropertyDescriptor(r,n);return t!==void 0&&o!==void 0&&Object.is(t.value,o.value)&&(t.writable||!1)===(o.writable||!1)&&(t.enumerable||!1)===(o.enumerable||!1)&&(t.configurable||!1)===(o.configurable||!1)&&t.get===o.get&&t.set===o.set}isGetInvariant(t,r){const n=this._getOwnPropertyDescriptor(t,r);return n!==void 0&&n.configurable!==!0&&n.writable!==!0}unsubscribe(){this._descriptorCache=null,this._pathCache=null,this._proxyCache=null,this.isUnsubscribed=!0}}function P(e){return toString.call(e)==="[object Object]"}function v(){return!0}function _(e,t){return e.length!==t.length||e.some((r,n)=>t[n]!==r)}const J=new Set(["hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"]),ae=new Set(["concat","includes","indexOf","join","keys","lastIndexOf"]),Y={push:v,pop:v,shift:v,unshift:v,copyWithin:_,reverse:_,sort:_,splice:_,flat:_,fill:_},ie=new Set([...J,...ae,...Object.keys(Y)]);function T(e,t){if(e.size!==t.size)return!0;for(const r of e)if(!t.has(r))return!0;return!1}const Z=["keys","values","entries"],X=new Set(["has","toString"]),ee={add:T,clear:T,delete:T,forEach:T},de=new Set([...X,...Object.keys(ee),...Z]);function E(e,t){if(e.size!==t.size)return!0;let r;for(const[n,o]of e)if(r=t.get(n),r!==o||r===void 0&&!t.has(n))return!0;return!1}const le=new Set([...X,"get"]),te={set:E,clear:E,delete:E,forEach:E},fe=new Set([...le,...Object.keys(te),...Z]);class y{constructor(t,r,n,o){this._path=r,this._isChanged=!1,this._clonedCache=new Set,this._hasOnValidate=o,this._changes=o?[]:null,this.clone=r===void 0?t:this._shallowClone(t)}static isHandledMethod(t){return J.has(t)}_shallowClone(t){let r=t;if(P(t))r={...t};else if(m(t)||ArrayBuffer.isView(t))r=[...t];else if(t instanceof Date)r=new Date(t);else if(t instanceof Set)r=new Set([...t].map(n=>this._shallowClone(n)));else if(t instanceof Map){r=new Map;for(const[n,o]of t.entries())r.set(n,this._shallowClone(o))}return this._clonedCache.add(r),r}preferredThisArg(t,r,n,o){return t?(m(o)?this._onIsChanged=Y[r]:o instanceof Set?this._onIsChanged=ee[r]:o instanceof Map&&(this._onIsChanged=te[r]),o):n}update(t,r,n){const o=R.after(t,this._path);if(r!=="length"){let p=this.clone;R.walk(o,a=>{p!=null&&p[a]&&(this._clonedCache.has(p[a])||(p[a]=this._shallowClone(p[a])),p=p[a])}),this._hasOnValidate&&this._changes.push({path:o,property:r,previous:n}),p!=null&&p[r]&&(p[r]=n)}this._isChanged=!0}undo(t){let r;for(let n=this._changes.length-1;n!==-1;n--)r=this._changes[n],R.get(t,r.path)[r.property]=r.previous}isChanged(t){return this._onIsChanged===void 0?this._isChanged:this._onIsChanged(this.clone,t)}isPathApplicable(t){return R.isRootPath(this._path)||R.isSubPath(t,this._path)}}class z extends y{static isHandledMethod(t){return ie.has(t)}}class he extends y{undo(t){t.setTime(this.clone.getTime())}isChanged(t,r){return!r(this.clone.valueOf(),t.valueOf())}}class K extends y{static isHandledMethod(t){return de.has(t)}undo(t){for(const r of this.clone)t.add(r);for(const r of t)this.clone.has(r)||t.delete(r)}}class j extends y{static isHandledMethod(t){return fe.has(t)}undo(t){for(const[r,n]of this.clone.entries())t.set(r,n);for(const r of t.keys())this.clone.has(r)||t.delete(r)}}class ue extends y{constructor(t,r,n,o){super(void 0,r,n,o),this._argument1=n[0],this._weakValue=t.has(this._argument1)}isChanged(t){return this._weakValue!==t.has(this._argument1)}undo(t){this._weakValue&&!t.has(this._argument1)?t.add(this._argument1):t.delete(this._argument1)}}class me extends y{constructor(t,r,n,o){super(void 0,r,n,o),this._weakKey=n[0],this._weakHas=t.has(this._weakKey),this._weakValue=t.get(this._weakKey)}isChanged(t){return this._weakValue!==t.get(this._weakKey)}undo(t){const r=t.has(this._weakKey);this._weakHas&&!r?t.set(this._weakKey,this._weakValue):!this._weakHas&&r?t.delete(this._weakKey):this._weakValue!==t.get(this._weakKey)&&t.set(this._weakKey,this._weakValue)}}class ${constructor(t){this._stack=[],this._hasOnValidate=t}static isHandledType(t){return P(t)||m(t)||L(t)}static isHandledMethod(t,r){return P(t)?y.isHandledMethod(r):m(t)?z.isHandledMethod(r):t instanceof Set?K.isHandledMethod(r):t instanceof Map?j.isHandledMethod(r):L(t)}get isCloning(){return this._stack.length>0}start(t,r,n){let o=y;m(t)?o=z:t instanceof Date?o=he:t instanceof Set?o=K:t instanceof Map?o=j:t instanceof WeakSet?o=ue:t instanceof WeakMap&&(o=me),this._stack.push(new o(t,r,n,this._hasOnValidate))}update(t,r,n){this._stack.at(-1).update(t,r,n)}preferredThisArg(t,r,n){const{name:o}=t,p=$.isHandledMethod(n,o);return this._stack.at(-1).preferredThisArg(p,o,r,n)}isChanged(t,r,n){return this._stack.at(-1).isChanged(t,r,n)}isPartOfClone(t){return this._stack.at(-1).isPathApplicable(t)}undo(t){this._previousClone!==void 0&&this._previousClone.undo(t)}stop(){return this._previousClone=this._stack.pop(),this._previousClone.clone}}const Re={equals:Object.is,isShallow:!1,pathAsArray:!1,ignoreSymbols:!1,ignoreUnderscores:!1,ignoreDetached:!1,details:!1},N=(e,t,r={})=>{r={...Re,...r};const n=Symbol("ProxyTarget"),{equals:o,isShallow:p,ignoreDetached:a,details:d}=r,f=new pe(o),q=typeof r.onValidate=="function",u=new $(q),A=(s,c,i,l,h)=>!q||u.isCloning||r.onValidate(R.concat(f.getPath(s),c),i,l,h)===!0,H=(s,c,i,l)=>{!W(f,r,c)&&!(a&&f.isDetached(s,e))&&D(f.getPath(s),c,i,l)},D=(s,c,i,l,h)=>{u.isCloning&&u.isPartOfClone(s)?u.update(s,c,l):t(R.concat(s,c),i,l,h)},x=s=>s&&(s[n]??s),Q=(s,c,i,l)=>{if(oe(s)||i==="constructor"||p&&!$.isHandledMethod(c,i)||W(f,r,i)||f.isGetInvariant(c,i)||a&&f.isDetached(c,e))return s;l===void 0&&(l=f.getPath(c));const h=R.concat(l,i),b=f.getPath(s);return b&&re(h,b)?f.getProxy(s,b,k,n):f.getProxy(s,h,k,n)},re=(s,c)=>{if(M(s)||s.length<=c.length||m(c)&&c.length===0)return!1;const i=m(s)?s:s.split(g),l=m(c)?c:c.split(g);return i.length<=l.length?!1:!l.some((h,b)=>h!==i[b])},k={get(s,c,i){if(M(c)){if(c===n||c===I)return s;if(c===F&&!f.isUnsubscribed&&f.getPath(s).length===0)return f.unsubscribe(),s}const l=L(s)?Reflect.get(s,c):Reflect.get(s,c,i);return Q(l,s,c)},set(s,c,i,l){i=x(i);const h=s[n]??s,b=h[c];if(o(b,i)&&c in s)return!0;const w=A(s,c,i,b);return w&&f.setProperty(h,c,i,l,b)?(H(s,c,s[c],b),!0):!w},defineProperty(s,c,i){if(!f.isSameDescriptor(i,s,c)){const l=s[c];A(s,c,i.value,l)&&f.defineProperty(s,c,i,l)&&H(s,c,i.value,l)}return!0},deleteProperty(s,c){if(!Reflect.has(s,c))return!0;const i=Reflect.get(s,c),l=A(s,c,void 0,i);return l&&f.deleteProperty(s,c,i)?(H(s,c,void 0,i),!0):!l},apply(s,c,i){const l=c[n]??c;if(f.isUnsubscribed)return Reflect.apply(s,l,i);if((d===!1||d!==!0&&!d.includes(s.name))&&$.isHandledType(l)){let h=R.initial(f.getPath(s));const b=$.isHandledMethod(l,s.name);u.start(l,h,i);let w=Reflect.apply(s,u.preferredThisArg(s,c,l),b?i.map(C=>x(C)):i);const ne=u.isChanged(l,o),B=u.stop();if($.isHandledType(w)&&b&&(c instanceof Map&&s.name==="get"&&(h=R.concat(h,i[0])),w=f.getProxy(w,h,k)),ne){const C={name:s.name,args:i,result:w},V=u.isCloning?R.initial(h):h,U=u.isCloning?R.last(h):"";A(R.get(e,V),U,l,B,C)?D(V,U,l,B,C):u.undo(l)}return(c instanceof Map||c instanceof Set)&&se(w)?ce(w,s,c,h,Q):w}return Reflect.apply(s,c,i)}},O=f.getProxy(e,r.pathAsArray?[]:"",k);return t=t.bind(O),q&&(r.onValidate=r.onValidate.bind(O)),O};N.target=e=>(e==null?void 0:e[I])??e;N.unsubscribe=e=>(e==null?void 0:e[F])??e;const S=e=>e.split(".").slice(0,3).reverse().join("."),be=e=>Array(4).fill(0).map((r,n)=>256-2**(8-Math.min(8,Math.max(0,e-n*8)))).join("."),qe=e=>{const t=e.split(".").map(Number),r=t[3]+3;return t[3]=r,t.join(".")},we=({devices:e})=>`
<p>Запуск ISP</p>
...
subnet ${e.hqRtr.interfaces.hqCli.netAddress} netmask ${be(e.hqRtr.interfaces.hqCli.mask)} {
&#9;range ${e.hqCli.interfaces.hqRtr.ip} ${qe(e.hqCli.interfaces.hqRtr.ip)};
...
<p><code>reboot</code></p>
<br>
`,Se=(e,{devices:t})=>{const r=document.createElement("table"),n=document.createElement("thead");n.innerHTML=`
    <tr>
