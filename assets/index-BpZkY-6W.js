(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const p of a.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&n(p)}).observe(document,{childList:!0,subtree:!0});function r(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(s){if(s.ep)return;s.ep=!0;const a=r(s);fetch(s.href,a)}})();const g=".",V=Symbol("target"),Z=Symbol("unsubscribe");function Q(e){return e instanceof Date||e instanceof Set||e instanceof Map||e instanceof WeakSet||e instanceof WeakMap||ArrayBuffer.isView(e)}function pe(e){return(typeof e=="object"?e===null:typeof e!="function")||e instanceof RegExp}const u=Array.isArray;function P(e){return typeof e=="symbol"}const R={after(e,t){return u(e)?e.slice(t.length):t===""?e:e.slice(t.length+1)},concat(e,t){return u(e)?(e=[...e],t&&e.push(t),e):t&&t.toString!==void 0?(e!==""&&(e+=g),P(t)?e+t.toString():e+t):e},initial(e){if(u(e))return e.slice(0,-1);if(e==="")return e;const t=e.lastIndexOf(g);return t===-1?"":e.slice(0,t)},last(e){if(u(e))return e.at(-1)??"";if(e==="")return e;const t=e.lastIndexOf(g);return t===-1?e:e.slice(t+1)},walk(e,t){if(u(e))for(const r of e)t(r);else if(e!==""){let r=0,n=e.indexOf(g);if(n===-1)t(e);else for(;r<e.length;)n===-1&&(n=e.length),t(e.slice(r,n)),r=n+1,n=e.indexOf(g,r)}},get(e,t){return this.walk(t,r=>{e&&(e=e[r])}),e},isSubPath(e,t){if(u(e)){if(e.length<t.length)return!1;for(let r=0;r<t.length;r++)if(e[r]!==t[r])return!1;return!0}return e.length<t.length?!1:e===t?!0:e.startsWith(t)?e[t.length]===g:!1},isRootPath(e){return u(e)?e.length===0:e===""}};function ie(e){return typeof e=="object"&&typeof e.next=="function"}function de(e,t,r,n,s){const a=e.next;if(t.name==="entries")e.next=function(){const p=a.call(this);return p.done===!1&&(p.value[0]=s(p.value[0],t,p.value[0],n),p.value[1]=s(p.value[1],t,p.value[0],n)),p};else if(t.name==="values"){const p=r[V].keys();e.next=function(){const h=a.call(this);return h.done===!1&&(h.value=s(h.value,t,p.next().value,n)),h}}else e.next=function(){const p=a.call(this);return p.done===!1&&(p.value=s(p.value,t,p.value,n)),p};return e}function G(e,t,r){return e.isUnsubscribed||t.ignoreSymbols&&P(r)||t.ignoreUnderscores&&r.charAt(0)==="_"||"ignoreKeys"in t&&t.ignoreKeys.includes(r)}class le{constructor(t){this._equals=t,this._proxyCache=new WeakMap,this._pathCache=new WeakMap,this.isUnsubscribed=!1}_getDescriptorCache(){return this._descriptorCache===void 0&&(this._descriptorCache=new WeakMap),this._descriptorCache}_getProperties(t){const r=this._getDescriptorCache();let n=r.get(t);return n===void 0&&(n={},r.set(t,n)),n}_getOwnPropertyDescriptor(t,r){if(this.isUnsubscribed)return Reflect.getOwnPropertyDescriptor(t,r);const n=this._getProperties(t);let s=n[r];return s===void 0&&(s=Reflect.getOwnPropertyDescriptor(t,r),n[r]=s),s}getProxy(t,r,n,s){if(this.isUnsubscribed)return t;const a=t[s],p=a??t;this._pathCache.set(p,r);let h=this._proxyCache.get(p);return h===void 0&&(h=a===void 0?new Proxy(t,n):t,this._proxyCache.set(p,h)),h}getPath(t){return this.isUnsubscribed?void 0:this._pathCache.get(t)}isDetached(t,r){return!Object.is(t,R.get(r,this.getPath(t)))}defineProperty(t,r,n){return Reflect.defineProperty(t,r,n)?(this.isUnsubscribed||(this._getProperties(t)[r]=n),!0):!1}setProperty(t,r,n,s,a){if(!this._equals(a,n)||!(r in t)){const p=this._getOwnPropertyDescriptor(t,r);return p!==void 0&&"set"in p?Reflect.set(t,r,n,s):Reflect.set(t,r,n)}return!0}deleteProperty(t,r,n){if(Reflect.deleteProperty(t,r)){if(!this.isUnsubscribed){const s=this._getDescriptorCache().get(t);s&&(delete s[r],this._pathCache.delete(n))}return!0}return!1}isSameDescriptor(t,r,n){const s=this._getOwnPropertyDescriptor(r,n);return t!==void 0&&s!==void 0&&Object.is(t.value,s.value)&&(t.writable||!1)===(s.writable||!1)&&(t.enumerable||!1)===(s.enumerable||!1)&&(t.configurable||!1)===(s.configurable||!1)&&t.get===s.get&&t.set===s.set}isGetInvariant(t,r){const n=this._getOwnPropertyDescriptor(t,r);return n!==void 0&&n.configurable!==!0&&n.writable!==!0}unsubscribe(){this._descriptorCache=null,this._pathCache=null,this._proxyCache=null,this.isUnsubscribed=!0}}function B(e){return toString.call(e)==="[object Object]"}function H(){return!0}function k(e,t){return e.length!==t.length||e.some((r,n)=>t[n]!==r)}const ee=new Set(["hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"]),he=new Set(["concat","includes","indexOf","join","keys","lastIndexOf"]),te={push:H,pop:H,shift:H,unshift:H,copyWithin:k,reverse:k,sort:k,splice:k,flat:k,fill:k},fe=new Set([...ee,...he,...Object.keys(te)]);function L(e,t){if(e.size!==t.size)return!0;for(const r of e)if(!t.has(r))return!0;return!1}const re=["keys","values","entries"],ne=new Set(["has","toString"]),se={add:L,clear:L,delete:L,forEach:L},me=new Set([...ne,...Object.keys(se),...re]);function N(e,t){if(e.size!==t.size)return!0;let r;for(const[n,s]of e)if(r=t.get(n),r!==s||r===void 0&&!t.has(n))return!0;return!1}const ue=new Set([...ne,"get"]),oe={set:N,clear:N,delete:N,forEach:N},Re=new Set([...ue,...Object.keys(oe),...re]);class _{constructor(t,r,n,s){this._path=r,this._isChanged=!1,this._clonedCache=new Set,this._hasOnValidate=s,this._changes=s?[]:null,this.clone=r===void 0?t:this._shallowClone(t)}static isHandledMethod(t){return ee.has(t)}_shallowClone(t){let r=t;if(B(t))r={...t};else if(u(t)||ArrayBuffer.isView(t))r=[...t];else if(t instanceof Date)r=new Date(t);else if(t instanceof Set)r=new Set([...t].map(n=>this._shallowClone(n)));else if(t instanceof Map){r=new Map;for(const[n,s]of t.entries())r.set(n,this._shallowClone(s))}return this._clonedCache.add(r),r}preferredThisArg(t,r,n,s){return t?(u(s)?this._onIsChanged=te[r]:s instanceof Set?this._onIsChanged=se[r]:s instanceof Map&&(this._onIsChanged=oe[r]),s):n}update(t,r,n){const s=R.after(t,this._path);if(r!=="length"){let a=this.clone;R.walk(s,p=>{a!=null&&a[p]&&(this._clonedCache.has(a[p])||(a[p]=this._shallowClone(a[p])),a=a[p])}),this._hasOnValidate&&this._changes.push({path:s,property:r,previous:n}),a!=null&&a[r]&&(a[r]=n)}this._isChanged=!0}undo(t){let r;for(let n=this._changes.length-1;n!==-1;n--)r=this._changes[n],R.get(t,r.path)[r.property]=r.previous}isChanged(t){return this._onIsChanged===void 0?this._isChanged:this._onIsChanged(this.clone,t)}isPathApplicable(t){return R.isRootPath(this._path)||R.isSubPath(t,this._path)}}class j extends _{static isHandledMethod(t){return fe.has(t)}}class be extends _{undo(t){t.setTime(this.clone.getTime())}isChanged(t,r){return!r(this.clone.valueOf(),t.valueOf())}}class K extends _{static isHandledMethod(t){return me.has(t)}undo(t){for(const r of this.clone)t.add(r);for(const r of t)this.clone.has(r)||t.delete(r)}}class Y extends _{static isHandledMethod(t){return Re.has(t)}undo(t){for(const[r,n]of this.clone.entries())t.set(r,n);for(const r of t.keys())this.clone.has(r)||t.delete(r)}}class we extends _{constructor(t,r,n,s){super(void 0,r,n,s),this._argument1=n[0],this._weakValue=t.has(this._argument1)}isChanged(t){return this._weakValue!==t.has(this._argument1)}undo(t){this._weakValue&&!t.has(this._argument1)?t.add(this._argument1):t.delete(this._argument1)}}class Se extends _{constructor(t,r,n,s){super(void 0,r,n,s),this._weakKey=n[0],this._weakHas=t.has(this._weakKey),this._weakValue=t.get(this._weakKey)}isChanged(t){return this._weakValue!==t.get(this._weakKey)}undo(t){const r=t.has(this._weakKey);this._weakHas&&!r?t.set(this._weakKey,this._weakValue):!this._weakHas&&r?t.delete(this._weakKey):this._weakValue!==t.get(this._weakKey)&&t.set(this._weakKey,this._weakValue)}}class A{constructor(t){this._stack=[],this._hasOnValidate=t}static isHandledType(t){return B(t)||u(t)||Q(t)}static isHandledMethod(t,r){return B(t)?_.isHandledMethod(r):u(t)?j.isHandledMethod(r):t instanceof Set?K.isHandledMethod(r):t instanceof Map?Y.isHandledMethod(r):Q(t)}get isCloning(){return this._stack.length>0}start(t,r,n){let s=_;u(t)?s=j:t instanceof Date?s=be:t instanceof Set?s=K:t instanceof Map?s=Y:t instanceof WeakSet?s=we:t instanceof WeakMap&&(s=Se),this._stack.push(new s(t,r,n,this._hasOnValidate))}update(t,r,n){this._stack.at(-1).update(t,r,n)}preferredThisArg(t,r,n){const{name:s}=t,a=A.isHandledMethod(n,s);return this._stack.at(-1).preferredThisArg(a,s,r,n)}isChanged(t,r,n){return this._stack.at(-1).isChanged(t,r,n)}isPartOfClone(t){return this._stack.at(-1).isPathApplicable(t)}undo(t){this._previousClone!==void 0&&this._previousClone.undo(t)}stop(){return this._previousClone=this._stack.pop(),this._previousClone.clone}}const qe={equals:Object.is,isShallow:!1,pathAsArray:!1,ignoreSymbols:!1,ignoreUnderscores:!1,ignoreDetached:!1,details:!1},U=(e,t,r={})=>{r={...qe,...r};const n=Symbol("ProxyTarget"),{equals:s,isShallow:a,ignoreDetached:p,details:h}=r,i=new le(s),q=typeof r.onValidate=="function",m=new A(q),y=(o,c,d,l,f)=>!q||m.isCloning||r.onValidate(R.concat(i.getPath(o),c),d,l,f)===!0,$=(o,c,d,l)=>{!G(i,r,c)&&!(p&&i.isDetached(o,e))&&v(i.getPath(o),c,d,l)},v=(o,c,d,l,f)=>{m.isCloning&&m.isPartOfClone(o)?m.update(o,c,l):t(R.concat(o,c),d,l,f)},C=o=>o&&(o[n]??o),T=(o,c,d,l)=>{if(pe(o)||d==="constructor"||a&&!A.isHandledMethod(c,d)||G(i,r,d)||i.isGetInvariant(c,d)||p&&i.isDetached(c,e))return o;l===void 0&&(l=i.getPath(c));const f=R.concat(l,d),b=i.getPath(o);return b&&ae(f,b)?i.getProxy(o,b,E,n):i.getProxy(o,f,E,n)},ae=(o,c)=>{if(P(o)||o.length<=c.length||u(c)&&c.length===0)return!1;const d=u(o)?o:o.split(g),l=u(c)?c:c.split(g);return d.length<=l.length?!1:!l.some((f,b)=>f!==d[b])},E={get(o,c,d){if(P(c)){if(c===n||c===V)return o;if(c===Z&&!i.isUnsubscribed&&i.getPath(o).length===0)return i.unsubscribe(),o}const l=Q(o)?Reflect.get(o,c):Reflect.get(o,c,d);return T(l,o,c)},set(o,c,d,l){d=C(d);const f=o[n]??o,b=f[c];if(s(b,d)&&c in o)return!0;const w=y(o,c,d,b);return w&&i.setProperty(f,c,d,l,b)?($(o,c,o[c],b),!0):!w},defineProperty(o,c,d){if(!i.isSameDescriptor(d,o,c)){const l=o[c];y(o,c,d.value,l)&&i.defineProperty(o,c,d,l)&&$(o,c,d.value,l)}return!0},deleteProperty(o,c){if(!Reflect.has(o,c))return!0;const d=Reflect.get(o,c),l=y(o,c,void 0,d);return l&&i.deleteProperty(o,c,d)?($(o,c,void 0,d),!0):!l},apply(o,c,d){const l=c[n]??c;if(i.isUnsubscribed)return Reflect.apply(o,l,d);if((h===!1||h!==!0&&!h.includes(o.name))&&A.isHandledType(l)){let f=R.initial(i.getPath(o));const b=A.isHandledMethod(l,o.name);m.start(l,f,d);let w=Reflect.apply(o,m.preferredThisArg(o,c,l),b?d.map(I=>C(I)):d);const ce=m.isChanged(l,s),F=m.stop();if(A.isHandledType(w)&&b&&(c instanceof Map&&o.name==="get"&&(f=R.concat(f,d[0])),w=i.getProxy(w,f,E)),ce){const I={name:o.name,args:d,result:w},W=m.isCloning?R.initial(f):f,z=m.isCloning?R.last(f):"";y(R.get(e,W),z,l,F,I)?v(W,z,l,F,I):m.undo(l)}return(c instanceof Map||c instanceof Set)&&ie(w)?de(w,o,c,f,T):w}return Reflect.apply(o,c,d)}},x=i.getProxy(e,r.pathAsArray?[]:"",E);return t=t.bind(x),q&&(r.onValidate=r.onValidate.bind(x)),x};U.target=e=>(e==null?void 0:e[V])??e;U.unsubscribe=e=>(e==null?void 0:e[Z])??e;const S=e=>e.split(".").slice(0,3).reverse().join("."),ye=e=>Array(4).fill(0).map((r,n)=>256-2**(8-Math.min(8,Math.max(0,e-n*8)))).join("."),ge=e=>{const t=e.split(".").map(Number),r=t[3]+3;return t[3]=r,t.join(".")},M=e=>e.split(".")[3],_e=({devices:e})=>`
<p>Запуск ISP</p>
...
${M(e.hqSrv.interfaces.hqRtr.ip)}&#9;IN&#9;PTR&#9;hq-srv.au-team.irpo.
${M(e.hqRtr.interfaces.hqSrv.ip)}&#9;IN&#9;PTR&#9;hq-rtr.au-team.irpo.
</code></pre>
<br>
...
&#9;IN&#9;A&#9;${e.hqSrv.interfaces.hqRtr.ip}
${M(e.hqCli.interfaces.hqRtr.ip)}&#9;IN&#9;PTR&#9;hq-cli.au-team.irpo.
${M(e.hqRtr.interfaces.hqCli.ip)}&#9;IN&#9;PTR&#9;hq-rtr.au-team.irpo.
</code></pre></p>
<br>
...
<p>добавляем второй строкой /raid5/nfs ${e.hqCli.interfaces.hqRtr.ip}(rw,sync,no_subtree_check)</p>
<p>сохраняем</p>
...
<br>
`,Ae=(e,{devices:t})=>{const r=document.createElement("table"),n=document.createElement("thead");n.innerHTML=`
    <tr>
