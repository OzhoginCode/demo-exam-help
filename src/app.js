...
const devices = {
  ...
  hqRtr: {
    ...
    interfaces: {
      ...
      hqSrv: { name: 'VLAN100', ip: '192.168.100.1', mask: '26', gateway: '-', destination: 'HQ-SRV', netAddress: '192.168.100.0' },
      hqCli: { name: 'VLAN200', ip: '192.168.200.1', mask: '28', gateway: '-', destination: 'HQ-CLI', netAddress: '192.168.200.0' },
  ...
  hqSrv: {
    name: 'HQ-SRV',
    interfaces: {
      hqRtr: { name: 'ens18', ip: '192.168.100.2', mask: '26', gateway: '192.168.100.1', destination: 'HQ-RTR', netAddress: '192.168.100.0' },
    },
  },
  hqCli: {
    name: 'HQ-CLI',
  ...
  brRtr: {
    ...
    interfaces: {
      ...
      brSrv: { name: 'ens19', ip: '192.168.0.1', mask: '27', gateway: '-', destination: 'BR-SRV', netAddress: '192.168.0.0' },
  ...
  brSrv: {
    name: 'BR-SRV',
    interfaces: {
      brRtr: { name: 'ens18', ip: '192.168.0.2', mask: '27', gateway: '192.168.0.1', destination: 'BR-RTR', netAddress: '192.168.0.0' },
    },
  },
};
